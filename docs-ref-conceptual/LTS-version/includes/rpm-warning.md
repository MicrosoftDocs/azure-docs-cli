...
> receive updates. Azure CLI has dropped support for Python 2.7 since version
> [2.1.0](/cli/azure/release-notes-azure-cli#february-18-2020). Newer versions of the CLI may not
