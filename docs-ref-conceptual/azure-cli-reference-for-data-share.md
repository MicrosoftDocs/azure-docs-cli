...
description: Learn how to use the Azure CLI to manage Azure Data Share. With 65 different commands available, you can work effectively with Data Share from a command line.
services: data-share
