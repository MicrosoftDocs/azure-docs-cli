...
| Question | Answer | Learn more
|-|-|-|
| How do I know what subscription I'm using? | `az account show --output table` | [How to manage Azure subscriptions with the Azure CLI](manage-azure-subscriptions-azure-cli.md)
