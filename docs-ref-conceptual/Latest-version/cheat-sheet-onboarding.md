...
| How do I get in-line help? | Every command has a `--help` parameter that results in descriptions and tips to display in your console. Example: `az account --help` or `az vm create --help` | You can also [Request support](https://github.com/Azure/azure-cli/issues/new/choose).
