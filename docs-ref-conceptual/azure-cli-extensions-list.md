...
| [netappfiles-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/netappfiles-preview) | 0.3.1 | Provides a preview for upcoming Azure NetApp Files (ANF) features. | Yes |
