...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.3 | Provides a preview for upcoming AKS features | Yes |
...
| [eventgrid](https://github.com/Azure/azure-cli-extensions) | 0.4.2 | Microsoft Azure Command-Line Tools EventGrid Command Module. | Yes |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 0.1.6 | Manage networking Front Doors. | Yes |
...
| [mesh](https://github.com/Azure/azure-cli-extensions) | 0.10.5 | Support for Microsoft Azure Service Fabric Mesh - Public Preview | Yes |
...
| [sap-hana](https://github.com/Azure/azure-hanaonazure-cli-extension) | 0.3.8 | Additional commands for working with SAP HanaOnAzure instances. |  |
...
| [subscription](https://github.com/Azure/azure-cli-extensions) | 0.1.2 | Support for subscription management preview. |  |
...
| [vm-repair](https://github.com/Azure/azure-cli-extensions/tree/master/src/vm-repair) | 0.1.0 | Auto repair commands to fix VMs. |  |
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.18 | Additional commands for Azure AppService. | Yes |