...
| [application-insights](https://github.com/Azure/azure-cli-extensions/tree/master/src/application-insights) | 0.1.2 | Support for managing Application Insights components and querying metrics, events, and logs from such components. | Yes |
...
| [azure-cli-iot-ext](https://github.com/azure/azure-iot-cli-extension) | 0.8.8 | The Azure IoT extension for Azure CLI. |  |
...
| [azure-firewall](https://github.com/Azure/azure-cli-extensions/tree/master/src/azure-firewall) | 0.1.8 | Manage Azure Firewall resources. | Yes |
