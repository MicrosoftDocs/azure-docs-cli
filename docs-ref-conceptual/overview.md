...
Please review the [Install article](install-az-cli.md) to get Azure CLI 2.0 up and running on your system. Then read the [Get Started](get-started-with-az-cli.md) article to begin using it.
