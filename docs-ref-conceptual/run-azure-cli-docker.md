...
> [!WARNING]
> Azure CLI 2.63.0, released in July 2024, is the last version based on the Alpine 10 image and will not receive updates. Consider migrating to the Azure Linux based image for the Azure CLI.
