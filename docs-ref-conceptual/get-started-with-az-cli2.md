...
> [!NOTE]
> Azure requires that you avoid using easily guessed usernames/passwords; there are specific rules for what 
characters can be used as well as the minimum length of both username and password.  Substitute your own username/password when running the following command.
