...
To see the extensions provided and maintained by Microsoft, use the [az extension list-available](../latest/docs-ref-autogen/extension.yml#az_extension_list_available) command.
