...
You can also [install](install-azure-cli.md) the CLI and run it locally form the command line.  Once you have installed the CLI run `az login` to log in with your default subscription.
