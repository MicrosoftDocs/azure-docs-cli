---
title: Install the Azure CLI with Homebrew for macOS
description: How to install the Azure CLI with Homebrew on macOS
author: sptramer
ms.author: sttramer
manager: carmonm
ms.date: 09/09/2018
...
# Install Azure CLI with Homebrew on macOS
