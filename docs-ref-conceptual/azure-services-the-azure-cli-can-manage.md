...
The Azure CLI is available across many Azure services, and is a flexible yet powerful tool for Azure service management.  This article provides the list of Azure services the Azure CLI can manage.
