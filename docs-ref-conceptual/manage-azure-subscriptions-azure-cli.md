...
To see the subscription you're currently using, run the [az account show](../latest/docs-ref-autogen/account.yml#az_account_show) command:
...
You can change your active subscription by using the [az account set](../latest/docs-ref-autogen/account.yml#az_account_set) command.

Get a list of your subscriptions with the [az account list](../latest/docs-ref-autogen/account.yml#az_account_list) command:
...
To switch to a different subscription, use [az account set](../latest/docs-ref-autogen/account.yml#az_account_set) with the subscription ID or name you want to switch to.
...
If you run the [az account list](../latest/docs-ref-autogen/account.yml#az_account_list) command again, the `IsDefault` column shows your current active subscription.
...
You can create a management group for several of your subscriptions by using the [az account management-group create](../latest/docs-ref-autogen/account/management-group.yml#az_account_management_group_create) command:

```azurecli
az account management-group create --name Contoso01
```

To see all your management groups, use the [az account management-group list](../latest/docs-ref-autogen/account/management-group.yml#az_account_management_group_list) command:

```azurecli
az account management-group list
```

Add subscriptions to your new group by using the [az account management-group subscription add](../latest/docs-ref-autogen/account/management-group/subscription.yml#az_account_management_group_subscription_add) command:
...
To remove a subscription, use the [az account management-group subscription remove](../latest/docs-ref-autogen/account/management-group/subscription.yml#az_account_management_group_subscription_remove) command:

```azurecli
az account management-group subscription remove --name Contoso01 --subscription "My Demos"
```

To remove a management group, run the [az account management-group delete](../latest/docs-ref-autogen/account/management-group.yml#az_account_management_group_delete) command:
...
In Azure CLI, use the [az account lock](../latest/docs-ref-autogen/account/lock.yml) commands. For instance, the [az account lock create](../latest/docs-ref-autogen/account/lock.yml#az_account_lock_create) command can prevent users from deleting a subscription:
...
To see the current locks on your subscription, use the [az account lock list](../latest/docs-ref-autogen/account/lock.yml#az_account_lock_list) command:
...
To see details for a lock, use the [az account lock show](../latest/docs-ref-autogen/account/lock.yml#az_account_lock_show) command:

```azurecli
az account lock show --name "Cannot delete subscription"
```

You can remove a lock by using the [az account lock delete](../latest/docs-ref-autogen/account/lock.yml#az_account_lock_delete) command:
