...
|  |  | [Create a resource group](/azure/cosmos-db/table/quickstart-nodejs)
|  |  | [Get the latest restorable timestamp for continuous backup accounts](/azure/cosmos-db/get-latest-restore-timestamp)
|  |  | [Create the table for the application to use](/azure/cosmos-db/table/quickstart-java)
...
| **custom-providers** | [az custom-providers resource-provider ](/cli/azure/custom-providers/resource-provider) | [Quickstart: Create Azure Custom Resource Provider and deploy custom resources](/azure/azure-resource-manager/custom-providers/create-custom-provider)
