...
|  | [Configure cross-tenant customer-managed keys for your Azure Cosmos DB account with Azure Key Vault](https://learn.microsoft.com/azure/cosmos-db/how-to-setup-cross-tenant-customer-managed-keys)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az aks](/cli/azure/aks) | [Use the Azure Key Vault provider for Secrets Store CSI Driver in an Azure Kubernetes Service (AKS) cluster](https://learn.microsoft.com/azure/aks/csi-secrets-store-driver)
...
|  | [Quickstart: Deploy an Azure Kubernetes Service (AKS) cluster using Azure portal](https://learn.microsoft.com/azure/aks/learn/quick-kubernetes-deploy-portal)
...
| [az aks addon](/cli/azure/aks/addon) | [Plug in CA certificates for Istio-based service mesh add-on on Azure Kubernetes Service](https://learn.microsoft.com/azure/aks/istio-plugin-ca)
|  | [Azure Key Vault provider for Secrets Store CSI Driver for Azure Kubernetes Service (AKS) configuration and troubleshooting options](https://learn.microsoft.com/azure/aks/csi-secrets-store-configuration-options)
...
| [az aks approuting zone](/cli/azure/aks/approuting/zone) | [Set up a custom domain name and SSL certificate with the application routing add-on](https://learn.microsoft.com/azure/aks/app-routing-dns-ssl)
...
| [az aks command](/cli/azure/aks/command) | [Access a private Azure Kubernetes Service (AKS) cluster](https://learn.microsoft.com/azure/aks/access-private-cluster)
...
| [az aks nodepool](/cli/azure/aks/nodepool) | [Use the cluster autoscaler in Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/cluster-autoscaler)
...
|  | [Deploy a Windows Server container on an Azure Kubernetes Service (AKS) cluster using Azure CLI](https://learn.microsoft.com/azure/aks/learn/quick-windows-container-deploy-cli)
...
|  | [Enable Federal Information Process Standard (FIPS) for Azure Kubernetes Service (AKS) node pools](https://learn.microsoft.com/azure/aks/enable-fips-nodes)
|  | [Host-based encryption on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/enable-host-encryption)
|  | [Use Windows GPUs for compute-intensive workloads on Azure Kubernetes Service (AKS) (preview)](https://learn.microsoft.com/azure/aks/use-windows-gpu)
...
| [az aks trustedaccess rolebinding](/cli/azure/aks/trustedaccess/rolebinding) | [Get secure access for Azure resources in Azure Kubernetes Service by using Trusted Access](https://learn.microsoft.com/azure/aks/trusted-access-feature)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az attestation](/cli/azure/attestation) | [Deploy an AKS cluster with Confidential Containers and a default policy](https://learn.microsoft.com/azure/aks/deploy-confidential-containers-default-policy)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az confcom](/cli/azure/confcom) | [Deploy an AKS cluster with Confidential Containers and a default policy](https://learn.microsoft.com/azure/aks/deploy-confidential-containers-default-policy)
...
|  | [Tutorial: Use code interpreter sessions in LlamaIndex with Azure Container Apps](/azure/container-apps/sessions-tutorial-llamaindex)
|  | [Migrate an application to use passwordless connections with Azure Cosmos DB for NoSQL](https://learn.microsoft.com/azure/cosmos-db/nosql/migrate-passwordless)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az cosmosdb](/cli/azure/cosmosdb) | [Configure IP firewall in Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/how-to-configure-firewall)
|  | [Get started with Azure Cosmos DB for NoSQL using .NET](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-dotnet-get-started)
...
|  | [JavaScript Tutorial: Upload and analyze a file with Azure Functions and Blob Storage](/azure/storage/blobs/blob-upload-function-trigger-javascript)
|  | [Get started with Azure Cosmos DB for NoSQL using Python](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-python-get-started)
...
| [az cosmosdb cassandra keyspace](/cli/azure/cosmosdb/cassandra/keyspace) | [Create an Azure Cosmos DB Cassandra API serverless account, keyspace and table using Azure CLI](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/cassandra/serverless)
...
| [az cosmosdb cassandra table](/cli/azure/cosmosdb/cassandra/table) | [Throughput (RU/s) operations with Azure CLI for a keyspace or table for Azure Cosmos DB - API for Cassandra](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/cassandra/throughput)
...
| [az cosmosdb gremlin database](/cli/azure/cosmosdb/gremlin/database) | [Throughput (RU/s) operations with Azure CLI for a database or graph for Azure Cosmos DB - API for Gremlin](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/gremlin/throughput)
...
| [az cosmosdb gremlin graph](/cli/azure/cosmosdb/gremlin/graph) | [Use Azure CLI to create a Gremlin serverless account, database, and graph](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/gremlin/serverless)
|  | [Use Azure CLI to create a API for Gremlin account, database, and graph with autoscale](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/gremlin/autoscale)
...
|  | [Configure and use Azure Synapse Link for Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/configure-synapse-link)
|  | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
|  | [Quickstart: Azure Cosmos DB for Apache Gremlin library for .NET](https://learn.microsoft.com/azure/cosmos-db/gremlin/quickstart-dotnet)
|  | [Quickstart: Azure Cosmos DB for Apache Gremlin library for Python](https://learn.microsoft.com/azure/cosmos-db/gremlin/quickstart-python)
|  | [Quickstart: Traverse vertices and edges with the Gremlin console and Azure Cosmos DB for Apache Gremlin](https://learn.microsoft.com/azure/cosmos-db/gremlin/quickstart-console)
...
|  | [Configure customer-managed keys for your Azure Cosmos DB account with Azure Managed HSM Key Vault](https://learn.microsoft.com/azure/cosmos-db/how-to-setup-customer-managed-keys-mhsm)
| [az cosmosdb identity](/cli/azure/cosmosdb/identity) | [Create and manage container copy jobs in Azure Cosmos DB (Preview)](https://learn.microsoft.com/azure/cosmos-db/how-to-container-copy)
...
| [az cosmosdb keys](/cli/azure/cosmosdb/keys) | [Get started with Azure Cosmos DB for NoSQL using .NET](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-dotnet-get-started)
|  | [JavaScript Tutorial: Upload and analyze a file with Azure Functions and Blob Storage](/azure/storage/blobs/blob-upload-function-trigger-javascript)
|  | [Get started with Azure Cosmos DB for NoSQL using Python](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-python-get-started)
|  | [Get started with Azure Cosmos DB for MongoDB and Python](https://learn.microsoft.com/azure/cosmos-db/mongodb/how-to-python-get-started)
|  | [Migrate data to Azure Cosmos DB using the desktop data migration tool](https://learn.microsoft.com/azure/cosmos-db/how-to-migrate-desktop-tool)
...
|  | [Get started with Azure Cosmos DB for Table using .NET](https://learn.microsoft.com/azure/cosmos-db/table/how-to-dotnet-get-started)
|  | [Get started with Azure Cosmos DB for MongoDB using JavaScript](https://learn.microsoft.com/azure/cosmos-db/mongodb/how-to-javascript-get-started)
|  | [Get started with Azure Cosmos DB for NoSQL using JavaScript](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-javascript-get-started)
...
| [az cosmosdb mongodb collection](/cli/azure/cosmosdb/mongodb/collection) | [Create a database with autoscale and shared collections for API for MongoDB for Azure Cosmos DB using Azure CLI](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/mongodb/autoscale)
...
|  | [Create a serverless database and collection for API for MongoDB for Azure Cosmos DB using Azure CLI](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/mongodb/serverless)
|  | [Throughput (RU/s) operations with Azure CLI for a database or graph for Azure Cosmos DB for MongoDB](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/mongodb/throughput)
| [az cosmosdb mongodb database](/cli/azure/cosmosdb/mongodb/database) | [Create a database with autoscale and shared collections for API for MongoDB for Azure Cosmos DB using Azure CLI](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/mongodb/autoscale)
|  | [Build and run a containerized Python web app locally with MongoDB](/azure/developer/python/tutorial-containerize-deploy-python-web-app-azure-02)
|  | [Create a database and collection for API for MongoDB for Azure Cosmos DB using Azure CLI](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/mongodb/create)
...
|  | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
| [az cosmosdb mongodb restorable-database](/cli/azure/cosmosdb/mongodb/restorable-database) | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
...
|  | [Restore an Azure Cosmos DB account that uses continuous backup mode](https://learn.microsoft.com/azure/cosmos-db/restore-account-continuous-backup)
| [az cosmosdb restorable-database-account](/cli/azure/cosmosdb/restorable-database-account) | [Manage permissions to restore an Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/continuous-backup-restore-permissions)
|  | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
...
|  | [Throughput (RU/s) operations with Azure CLI for a database or container for Azure Cosmos DB for NoSQL](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/nosql/throughput)
|  | [Restore an Azure Cosmos DB account that uses continuous backup mode](https://learn.microsoft.com/azure/cosmos-db/restore-account-continuous-backup)
| [az cosmosdb sql restorable-container](/cli/azure/cosmosdb/sql/restorable-container) | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
...
| [az cosmosdb sql role assignment](/cli/azure/cosmosdb/sql/role/assignment) | [Configure role-based access control with Microsoft Entra ID for your Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-setup-rbac)
...
|  | [Use a service principal with the Spark 3 connector for Azure Cosmos DB for NoSQL](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-spark-service-principal)
| [az cosmosdb sql role definition](/cli/azure/cosmosdb/sql/role/definition) | [Migrate an application to use passwordless connections with Azure Cosmos DB for NoSQL](https://learn.microsoft.com/azure/cosmos-db/nosql/migrate-passwordless)
|  | [Cosmos DB data source for a resolver](/azure/api-management/cosmosdb-data-source-policy)
|  | [Restore a deleted container or database to the same Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
| [az cosmosdb table](/cli/azure/cosmosdb/table) | [Throughput (RU/s) operations with Azure CLI for a table for Azure Cosmos DB for Table](https://learn.microsoft.com/azure/cosmos-db/scripts/cli/table/throughput)
...
|  | [Quickstart: Build an API for Table app with Python SDK and Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/table/quickstart-python)
|  | [Quickstart: Build a API for Table app with Node.js and Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/table/quickstart-nodejs)
|  | [Quickstart: Build a API for Table app with Java SDK and Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/table/quickstart-java)
...
|  | [Use Windows Annual Channel for Containers on Azure Kubernetes Service (AKS) (Preview)](https://learn.microsoft.com/azure/aks/windows-annual-channel)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az grafana](/cli/azure/grafana) | [Create infrastructure for deploying a highly available PostgreSQL database on AKS](https://learn.microsoft.com/azure/aks/create-postgresql-ha)
|  | [Set up Advanced Network Observability for Azure Kubernetes Service (AKS) - Azure managed Prometheus and Grafana (Preview)](https://learn.microsoft.com/azure/aks/advanced-network-observability-cli)
|  | [Set up Network Observability for Azure Kubernetes Service (AKS) - Azure managed Prometheus and Grafana](https://learn.microsoft.com/azure/aks/network-observability-managed-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az hpc-cache](/cli/azure/hpc-cache) | [Integrate Azure HPC Cache with Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/azure-hpc-cache)
...
|  | [Install the Dapr extension for Azure Kubernetes Service (AKS) and Arc-enabled Kubernetes](https://learn.microsoft.com/azure/aks/dapr)
|  | [Migrate from Dapr OSS to the Dapr extension for Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/dapr-migration)
|  | [Azure App Configuration extension for Azure Kubernetes Service (Preview)](https://learn.microsoft.com/azure/aks/azure-app-configuration)
...
|  | [Tutorial: Build and deploy container images in the cloud with Azure Container Registry Tasks](/azure/container-registry/container-registry-tutorial-quick-task)
| [az keyvault certificate](/cli/azure/keyvault/certificate) | [Set up a custom domain name and SSL certificate with the application routing add-on](https://learn.microsoft.com/azure/aks/app-routing-dns-ssl)
...
|  | [Use the Azure CLI to enable end-to-end encryption using encryption at host](/azure/virtual-machines/linux/disks-enable-host-based-encryption-cli)
|  | [Data encryption for Azure Database for MySQL - Flexible Server with Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/how-to-data-encryption-cli)
|  | [Configure customer-managed keys for your Azure Cosmos DB account with Azure Managed HSM Key Vault](https://learn.microsoft.com/azure/cosmos-db/how-to-setup-customer-managed-keys-mhsm)
...
|  | [Bring your own keys (BYOK) with Azure managed disks in Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/azure-disk-customer-managed-keys)
|  | [Configure cross-tenant customer-managed keys for your Azure Cosmos DB account with Azure Key Vault](https://learn.microsoft.com/azure/cosmos-db/how-to-setup-cross-tenant-customer-managed-keys)
|  | [Deploy an AKS cluster with Confidential Containers and a default policy](https://learn.microsoft.com/azure/aks/deploy-confidential-containers-default-policy)
...
|  | [Protect Azure Cosmos DB resources with locks](https://learn.microsoft.com/azure/cosmos-db/resource-locks)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az managed-cassandra cluster](/cli/azure/managed-cassandra/cluster) | [Quickstart: Configure a hybrid cluster with Azure Managed Instance for Apache Cassandra](https://learn.microsoft.com/azure/managed-instance-apache-cassandra/configure-hybrid-cluster-cli)
...
|  | [Quickstart: Create an Azure Managed Instance for Apache Cassandra cluster from the Azure portal](https://learn.microsoft.com/azure/managed-instance-apache-cassandra/create-cluster-portal)
...
|  | [Create and manage Azure Database for MariaDB firewall rules by using the Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-manage-firewall-cli)
|  | [Configure SSL connectivity in your application to securely connect to Azure Database for MariaDB](https://learn.microsoft.com/azure/mariadb/howto-configure-ssl)
|  | [How to create and manage read replicas in Azure Database for MariaDB using the Azure CLI and REST API](https://learn.microsoft.com/azure/mariadb/howto-read-replicas-cli)
|  | [Restart Azure Database for MariaDB server using the Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-restart-server-cli)
...
|  | [Create and manage Azure Database for MariaDB VNet service endpoints using Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-manage-vnet-cli)
|  | [Create and manage Private Link for Azure Database for MariaDB using CLI](https://learn.microsoft.com/azure/mariadb/howto-configure-privatelink-cli)
|  | [Configure server parameters in Azure Database for MariaDB using the Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-configure-server-parameters-cli)
|  | [Configure and access Azure Database for MariaDB slow query logs by using Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-configure-server-logs-cli)
|  | [Configure and access Azure Database for MariaDB audit logs in the Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-configure-audit-logs-cli)
|  | [Enable and download server slow query logs of an Azure Database for MariaDB server using Azure CLI](https://learn.microsoft.com/azure/mariadb/scripts/sample-server-logs)
| [az mariadb server configuration](/cli/azure/mariadb/server/configuration) | [List and update configurations of an Azure Database for MariaDB server using Azure CLI](https://learn.microsoft.com/azure/mariadb/scripts/sample-change-server-configuration)
| [az mariadb server firewall-rule](/cli/azure/mariadb/server/firewall-rule) | [Quickstart: Create an Azure Database for MariaDB server by using the Azure CLI](https://learn.microsoft.com/azure/mariadb/quickstart-create-mariadb-server-database-using-azure-cli)
|  | [Tutorial: Design an Azure Database for MariaDB using Azure CLI](https://learn.microsoft.com/azure/mariadb/tutorial-design-database-cli)
|  | [Create and manage Azure Database for MariaDB firewall rules by using the Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-manage-firewall-cli)
...
| [az mariadb server replica](/cli/azure/mariadb/server/replica) | [How to create and manage read replicas in Azure Database for MariaDB using the Azure CLI and REST API](https://learn.microsoft.com/azure/mariadb/howto-read-replicas-cli)
|  | [Create and manage Azure Database for MariaDB VNet service endpoints using Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-manage-vnet-cli)
| [az mariadb server vnet-rule](/cli/azure/mariadb/server/vnet-rule) | [Create a MariaDB server and configure a vNet rule using the Azure CLI](https://learn.microsoft.com/azure/mariadb/scripts/sample-create-server-with-vnet-rule)
|  | [Configure and access Azure Database for MariaDB slow query logs by using Azure CLI](https://learn.microsoft.com/azure/mariadb/howto-configure-server-logs-cli)
| [az mariadb server-logs](/cli/azure/mariadb/server-logs) | [Enable and download server slow query logs of an Azure Database for MariaDB server using Azure CLI](https://learn.microsoft.com/azure/mariadb/scripts/sample-server-logs)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az monitor account](/cli/azure/monitor/account) | [Create infrastructure for deploying a highly available PostgreSQL database on AKS](https://learn.microsoft.com/azure/aks/create-postgresql-ha)
...
|  | [Monitor Azure Cosmos DB for MongoDB vCore diagnostics logs with Azure Monitor](https://learn.microsoft.com/azure/cosmos-db/mongodb/vcore/how-to-monitor-diagnostics-logs)
|  | [Monitor Azure Managed Instance for Apache Cassandra by using Azure Monitor](https://learn.microsoft.com/azure/managed-instance-apache-cassandra/monitor-clusters)
...
|  | [Major version upgrade in Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/how-to-upgrade)
...
|  | [Point-in-time restore in Azure Database for MySQL - Flexible Server with Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/how-to-restore-server-cli)
...
| [az mysql flexible-server ad-admin](/cli/azure/mysql/flexible-server/ad-admin) | [Use Java and JDBC with Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/connect-java)
...
|  | [Quickstart: Create an instance of Azure Database for MySQL - Flexible Server by using Terraform](https://learn.microsoft.com/azure/mysql/flexible-server/quickstart-create-terraform)
| [az mysql flexible-server db](/cli/azure/mysql/flexible-server/db) | [Use Java and JDBC with Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/connect-java)
|  | [Quickstart: Connect with Azure Database for MySQL - Flexible Server by using Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/connect-azure-cli)
...
|  | [Migrate an application to use passwordless connections with Azure Database for MySQL](/azure/developer/java/spring-framework/migrate-mysql-to-passwordless-connection)
|  | [Configure passwordless database connections for Java apps on Oracle WebLogic Servers](/azure/developer/java/ee/how-to-configure-passwordless-datasource)
|  | [Migrate MySQL on-premises or Virtual Machine (VM) workload to Azure Database for MySQL - Flexible Server using Azure Database for MySQL Import CLI](https://learn.microsoft.com/azure/mysql/migrate/migrate-external-mysql-import-cli)
| [az mysql flexible-server import](/cli/azure/mysql/flexible-server/import) | [Migrate Azure Database for MySQL - Single Server to Flexible Server using Azure Database for MySQL Import CLI](https://learn.microsoft.com/azure/mysql/migrate/migrate-single-flexible-mysql-import-cli)
|  | [Tutorial: Query Performance Insight for Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/tutorial-query-performance-insights)
|  | [Configure audit logs on Azure Database for MySQL - Flexible Server using Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/scripts/sample-cli-audit-logs)
...
| [az mysql flexible-server parameter](/cli/azure/mysql/flexible-server/parameter) | [List and change server parameters of Azure Database for MySQL - Flexible Server using Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/scripts/sample-cli-change-server-parameters)
|  | [Tutorial: Deploy WordPress app on AKS with Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/tutorial-deploy-wordpress-on-aks)
|  | [Configure slow query logs on an Azure Database for MySQL - Flexible Server instance using Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/scripts/sample-cli-slow-query-logs)
...
|  | [Create and manage read replicas in Azure Database for MySQL - Flexible Server using Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/scripts/sample-cli-read-replicas)
| [az mysql flexible-server server-logs](/cli/azure/mysql/flexible-server/server-logs) | [List and download Azure Database for MySQL - Flexible Server logs by using the Azure CLI](https://learn.microsoft.com/azure/mysql/flexible-server/how-to-server-logs-cli)
|  | [Error logs in Azure Database for MySQL - Flexible Server (Preview)](https://learn.microsoft.com/azure/mysql/flexible-server/concepts-error-logs)
...
|  | [Tutorial: Query Performance Insight for Azure Database for MySQL - Flexible Server](https://learn.microsoft.com/azure/mysql/flexible-server/tutorial-query-performance-insights)
| [az mysql server configuration](/cli/azure/mysql/server/configuration) | [Enable and download server slow query logs of an Azure Database for MySQL server using Azure CLI](https://learn.microsoft.com/azure/mysql/scripts/sample-server-logs)
|  | [List and update configurations of an Azure Database for MySQL server using Azure CLI](https://learn.microsoft.com/azure/mysql/scripts/sample-change-server-configuration)
...
|  | [Create a MySQL server and configure a firewall rule using the Azure CLI](https://learn.microsoft.com/azure/mysql/scripts/sample-create-server-and-firewall-rule)
|  | [Migrate an application to use passwordless connections with Azure Database for MySQL](/azure/developer/java/spring-framework/migrate-mysql-to-passwordless-connection)
| [az mysql server-logs](/cli/azure/mysql/server-logs) | [Enable and download server slow query logs of an Azure Database for MySQL server using Azure CLI](https://learn.microsoft.com/azure/mysql/scripts/sample-server-logs)

## az netappfiles

|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az netappfiles account](/cli/azure/netappfiles/account) | [Configure Azure NetApp Files for Azure Kubernetes Service](https://learn.microsoft.com/azure/aks/azure-netapp-files)
...
| [az netappfiles pool](/cli/azure/netappfiles/pool) | [Configure Azure NetApp Files for Azure Kubernetes Service](https://learn.microsoft.com/azure/aks/azure-netapp-files)
|  | [Quickstart: Set up Azure NetApp Files and create an NFS volume](/azure/azure-netapp-files/azure-netapp-files-quickstart-set-up-account-create-volumes)
...
| [az netappfiles volume](/cli/azure/netappfiles/volume) | [Provision Azure NetApp Files NFS volumes for Azure Kubernetes Service](https://learn.microsoft.com/azure/aks/azure-netapp-files-nfs)
...
| [az network dns record-set a](/cli/azure/network/dns/record-set/a) | [Use TLS with an ingress controller on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/ingress-tls)
|  | [Manage DNS records and recordsets in Azure DNS using the Azure CLI](/azure/dns/dns-operations-recordsets-cli)
|  | [Quickstart: Create an Azure DNS zone and record using Azure CLI](/azure/dns/dns-getstarted-cli)
...
|  | [Deploy an IPv6 dual stack application using Basic Load Balancer - CLI](/azure/load-balancer/basic/virtual-network-ipv4-ipv6-dual-stack-cli)
|  | [Connect with RDP to Azure Kubernetes Service (AKS) cluster Windows Server nodes for maintenance or troubleshooting](https://learn.microsoft.com/azure/aks/rdp)
...
|  | [Deploy an IPv6 dual stack application using Basic Load Balancer - CLI](/azure/load-balancer/basic/virtual-network-ipv4-ipv6-dual-stack-cli)
|  | [Connect with RDP to Azure Kubernetes Service (AKS) cluster Windows Server nodes for maintenance or troubleshooting](https://learn.microsoft.com/azure/aks/rdp)
| [az network private-dns link vnet](/cli/azure/network/private-dns/link/vnet) | [Configure Azure Private Link for an Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-configure-private-endpoints)
|  | [Connect privately to an Azure container registry using Azure Private Link](/azure/container-registry/container-registry-private-link)
|  | [Configure network endpoints for accessing Azure file shares](/azure/storage/files/storage-files-networking-endpoints)
|  | [Provide a virtual network to an internal Azure Container Apps environment](/azure/container-apps/vnet-custom-internal)
|  | [Provide a virtual network to an external Azure Container Apps environment](/azure/container-apps/vnet-custom)
...
|  | [Quickstart: Create an Azure private DNS zone using the Azure CLI](/azure/dns/private-dns-getstarted-cli)
| [az network private-dns zone](/cli/azure/network/private-dns/zone) | [Configure Azure Private Link for an Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-configure-private-endpoints)
|  | [Connect privately to an Azure container registry using Azure Private Link](/azure/container-registry/container-registry-private-link)
|  | [Configure network endpoints for accessing Azure file shares](/azure/storage/files/storage-files-networking-endpoints)
|  | [Provide a virtual network to an internal Azure Container Apps environment](/azure/container-apps/vnet-custom-internal)
|  | [Provide a virtual network to an external Azure Container Apps environment](/azure/container-apps/vnet-custom)
...
|  | [Configure NGINX ingress controller to support Azure private DNS zone with application routing add-on](https://learn.microsoft.com/azure/aks/create-nginx-ingress-private-controller)
|  | [Integrate Azure HPC Cache with Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/azure-hpc-cache)
| [az network private-endpoint](/cli/azure/network/private-endpoint) | [Configure Azure Private Link for an Azure Cosmos DB account](https://learn.microsoft.com/azure/cosmos-db/how-to-configure-private-endpoints)
|  | [Connect privately to an Azure container registry using Azure Private Link](/azure/container-registry/container-registry-private-link)
...
|  | [Create and configure an Azure Kubernetes Services (AKS) cluster to use virtual nodes using Azure CLI](https://learn.microsoft.com/azure/aks/virtual-nodes-cli)
...
|  | [Use Azure CLI to create a Windows or Linux VM with Accelerated Networking](/azure/virtual-network/create-vm-accelerated-networking-cli)
|  | [Use TLS with an ingress controller on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/ingress-tls)
|  | [Use Azure Firewall to protect Azure Kubernetes Service (AKS) clusters](/azure/firewall/protect-azure-kubernetes-service)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az postgres](/cli/azure/postgres) | [Quickstart: Create an Azure Database for PostgreSQL server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/quickstart-create-server-database-azure-cli)
|  | [Quickstart: Use the az postgres up command to create an Azure Database for PostgreSQL - Single Server](https://learn.microsoft.com/azure/postgresql/single-server/quickstart-create-server-up-azure-cli)
| [az postgres db](/cli/azure/postgres/db) | [Quickstart: Use Java and JDBC with Azure Database for PostgreSQL](https://learn.microsoft.com/azure/postgresql/single-server/connect-java)
|  | [Manage an Azure Database for PostgreSQL Single server using the Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/how-to-manage-server-cli)
...
|  | [Major version upgrade of Azure Database for PostgreSQL - Flexible Server with Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-perform-major-version-upgrade-cli)
|  | [Stop/Start Azure Database for PostgreSQL - Flexible Server using Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-stop-start-server-cli)
|  | [Manage Azure Database for PostgreSQL - Flexible Server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-manage-server-cli)
|  | [Create and manage virtual networks with Private Link for Azure Database for PostgreSQL - Flexible Server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-manage-virtual-network-private-endpoint-cli)
|  | [Configure intelligent tuning for Azure Database for PostgreSQL - Flexible Server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-enable-intelligent-performance-cli)
|  | [Point-in-time restore of an Azure Database for PostgreSQL - Flexible Server instance with Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-restore-server-cli)
...
|  | [Create and manage virtual networks (VNET Integration) for Azure Database for PostgreSQL - Flexible Server using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-manage-virtual-network-cli)
|  | [Quickstart: Connect and query with Azure CLI  with Azure Database for PostgreSQL - Flexible Server](https://learn.microsoft.com/azure/postgresql/flexible-server/connect-azure-cli)
...
|  | [Configure passwordless database connections for Java apps on Oracle WebLogic Servers](/azure/developer/java/ee/how-to-configure-passwordless-datasource)
| [az postgres flexible-server firewall-rule](/cli/azure/postgres/flexible-server/firewall-rule) | [Quickstart: Use Java and JDBC with Azure Database for PostgreSQL - Flexible Server](https://learn.microsoft.com/azure/postgresql/flexible-server/connect-java)
|  | [Create and manage Azure Database for PostgreSQL - Flexible Server firewall rules using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-manage-firewall-cli)
|  | [Build and deploy a Python web app with Azure Container Apps and PostgreSQL](/azure/developer/python/tutorial-deploy-python-web-app-azure-container-apps-02)
|  | [Migrate an application to use passwordless connections with Azure Database for PostgreSQL](/azure/developer/java/spring-framework/migrate-postgresql-to-passwordless-connection)
...
|  | [Quickstart: Integrate with Azure Database for PostgreSQL and Azure Cache for Redis](/azure/spring-apps/enterprise/quickstart-integrate-azure-database-and-redis-enterprise)
|  | [Tutorial: Install JBoss EAP on Azure Virtual Machines (VMs) manually](/azure/developer/java/migration/migrate-jboss-eap-to-azure-vm-manually)
| [az postgres flexible-server migration](/cli/azure/postgres/flexible-server/migration) | [Tutorial: Migrate online from an Azure VM or an on-premises PostgreSQL server to Azure Database for PostgreSQL with the migration service Preview](https://learn.microsoft.com/azure/postgresql/migrate/migration-service/tutorial-migration-service-iaas-online)
|  | [Tutorial: Migrate online from AWS RDS PostgreSQL to Azure Database for PostgreSQL with the migration service Preview](https://learn.microsoft.com/azure/postgresql/migrate/migration-service/tutorial-migration-service-aws-online)
...
|  | [Tutorial: Migrate offline from an Azure VM or an on-premises PostgreSQL server to Azure Database for PostgreSQL with the migration service](https://learn.microsoft.com/azure/postgresql/migrate/migration-service/tutorial-migration-service-iaas-offline)
|  | [Tutorial: Migrate offline from AWS RDS PostgreSQL to Azure Database for PostgreSQL with the migration service](https://learn.microsoft.com/azure/postgresql/migrate/migration-service/tutorial-migration-service-aws-offline)
|  | [PostgreSQL extensions in Azure Database for PostgreSQL - Flexible Server](https://learn.microsoft.com/azure/postgresql/flexible-server/concepts-extensions)
...
| [az postgres flexible-server parameter](/cli/azure/postgres/flexible-server/parameter) | [Configure intelligent tuning for Azure Database for PostgreSQL - Flexible Server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-enable-intelligent-performance-cli)
|  | [Customize server parameters for Azure Database for PostgreSQL - Flexible Server using Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-configure-server-parameters-using-cli)
|  | [Quickstart: Integrate with Azure Database for PostgreSQL and Azure Cache for Redis](/azure/spring-apps/enterprise/quickstart-integrate-azure-database-and-redis-enterprise)
| [az postgres flexible-server private-endpoint-connection](/cli/azure/postgres/flexible-server/private-endpoint-connection) | [Create and manage virtual networks with Private Link for Azure Database for PostgreSQL - Flexible Server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-manage-virtual-network-private-endpoint-cli)
...
| [az postgres flexible-server server-logs](/cli/azure/postgres/flexible-server/server-logs) | [List and download Azure Database for PostgreSQL flexible server logs by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/flexible-server/how-to-server-logs-cli)
...
| [az postgres server](/cli/azure/postgres/server) | [Configure TLS connectivity in Azure Database for PostgreSQL - Single Server](https://learn.microsoft.com/azure/postgresql/single-server/concepts-ssl-connection-security)
|  | [Monitor and scale a single Azure Database for PostgreSQL - Flexible Server instance using Azure CLI](https://learn.microsoft.com/azure/postgresql/scripts/sample-scale-server-up-or-down)
...
|  | [Quickstart: Create an Azure Database for PostgreSQL server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/quickstart-create-server-database-azure-cli)
|  | [Quickstart: Use Java and JDBC with Azure Database for PostgreSQL](https://learn.microsoft.com/azure/postgresql/single-server/connect-java)
|  | [Logical decoding](https://learn.microsoft.com/azure/postgresql/single-server/concepts-logical)
| [az postgres server ad-admin](/cli/azure/postgres/server/ad-admin) | [Quickstart: Use Java and JDBC with Azure Database for PostgreSQL](https://learn.microsoft.com/azure/postgresql/single-server/connect-java)
|  | [Enable and download server slow query logs of an Azure Database for PostgreSQL - Flexible Server instance using Azure CLI](https://learn.microsoft.com/azure/postgresql/scripts/sample-server-logs)
...
|  | [Monitor performance with the Query Store](https://learn.microsoft.com/azure/postgresql/single-server/concepts-query-store)
|  | [Logical decoding](https://learn.microsoft.com/azure/postgresql/single-server/concepts-logical)
|  | [Customize server configuration parameters for Azure Database for PostgreSQL - Single Server using Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/how-to-configure-server-parameters-using-cli)
|  | [Create and manage read replicas from the Azure CLI, REST API](https://learn.microsoft.com/azure/postgresql/single-server/how-to-read-replicas-cli)
...
|  | [Quickstart: Use Java and JDBC with Azure Database for PostgreSQL](https://learn.microsoft.com/azure/postgresql/single-server/connect-java)
|  | [Logical decoding](https://learn.microsoft.com/azure/postgresql/single-server/concepts-logical)
|  | [Tutorial: Design an Azure Database for PostgreSQL - Single Server using Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/tutorial-design-database-using-azure-cli)
| [az postgres server key](/cli/azure/postgres/server/key) | [Validating data encryption for Azure Database for PostgreSQL](https://learn.microsoft.com/azure/postgresql/single-server/how-to-data-encryption-validation)
|  | [Data encryption for Azure Database for PostgreSQL Single server by using the Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/how-to-data-encryption-cli)
| [az postgres server replica](/cli/azure/postgres/server/replica) | [Create and manage read replicas from the Azure CLI, REST API](https://learn.microsoft.com/azure/postgresql/single-server/how-to-read-replicas-cli)
| [az postgres server vnet-rule](/cli/azure/postgres/server/vnet-rule) | [Create an Azure Database for PostgreSQL - Flexible Server instance and configure a vNet rule using the Azure CLI](https://learn.microsoft.com/azure/postgresql/scripts/sample-create-server-with-vnet-rule)
|  | [Create and manage VNet service endpoints for Azure Database for PostgreSQL - Single Server using Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/how-to-manage-vnet-using-cli)
...
|  | [Configure and access server logs by using Azure CLI](https://learn.microsoft.com/azure/postgresql/single-server/how-to-configure-server-logs-using-cli)
...
| [az servicebus namespace](/cli/azure/servicebus/namespace) | [Securely scale your applications using the KEDA add-on and workload identity on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/keda-workload-identity)
|  | [Configure cross-tenant workload identity on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/workload-identity-cross-tenant)
...
|  | [Tutorial - Use PaaS services with an Azure Kubernetes Service (AKS) cluster](https://learn.microsoft.com/azure/aks/tutorial-kubernetes-paas-services)
|  | [Configure cross-tenant workload identity on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/workload-identity-cross-tenant)
| [az servicebus queue](/cli/azure/servicebus/queue) | [Securely scale your applications using the KEDA add-on and workload identity on Azure Kubernetes Service (AKS)](https://learn.microsoft.com/azure/aks/keda-workload-identity)
...
|  | [How to enable soft delete on Azure file shares](/azure/storage/files/storage-files-enable-soft-delete)
|  | [How to enable your own persistent storage in Azure Spring Apps with the Standard consumption and dedicated plan](/azure/spring-apps/consumption-dedicated/how-to-custom-persistent-storage-with-standard-consumption)
| [az storage table](/cli/azure/storage/table) | [How to use the Azure SDK for Go with Azure Table](https://learn.microsoft.com/azure/cosmos-db/table/how-to-use-go)
...
| [az vm host](/cli/azure/vm/host) | [Add Azure Dedicated Host to an Azure Kubernetes Service (AKS) cluster](https://learn.microsoft.com/azure/aks/use-azure-dedicated-hosts)
|  | [Deploy VMs and scale sets to dedicated hosts](/azure/virtual-machines/dedicated-hosts-how-to)
| [az vm host group](/cli/azure/vm/host/group) | [Add Azure Dedicated Host to an Azure Kubernetes Service (AKS) cluster](https://learn.microsoft.com/azure/aks/use-azure-dedicated-hosts)
|  | [Deploy VMs and scale sets to dedicated hosts](/azure/virtual-machines/dedicated-hosts-how-to)
