...
|  | [Manage your Azure subscriptions at scale with management groups](/azure/governance/management-groups/manage)
| [az account subscription](/cli/azure/account/subscription) | [Overview: Deploy a serverless Python cloud ETL solution on Azure](/azure/developer/python/tutorial-deploy-azure-cloud-python-etl-01-overview)
...
|  | [Azure Container Registry (ACR) introduces the Conditional Access policy](/azure/container-registry/container-registry-enable-conditional-access-policy)
...
|  | [How to install AKS service on Azure Stack HCI, along side Arc VMs](/azure/aks/hybrid/deploy-aks-service-hci)
...
|  | [Quickstart: Using Azure CLI to deploy an AKS hybrid cluster on a Windows Server node in an Azure VM](/azure/aks/hybrid/aks-hybrid-preview-azure-vm)
|  | [How to install Arc Resource Bridge on Windows Server using the command line](/azure/aks/hybrid/deploy-arc-resource-bridge-windows-server)
|  | [Tutorial GÇô Deploy Active Directory connector using Azure CLI](/azure/azure-arc/data/deploy-active-directory-connector-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az attestation](/cli/azure/attestation) | [Configure an Azure Attestation provider using Terraform](/azure/developer/terraform/create-attestation-provider)
...
| [az azurestackhci virtualnetwork](/cli/azure/azurestackhci/virtualnetwork) | [Create virtual networks (preview)](/azure-stack/hci/manage/create-virtual-networks)
|  | [Uninstall Azure Arc VM management (preview)](/azure-stack/hci/manage/uninstall-arc-resource-bridge)
...
|  | [Quickstart: Back up SAP HANA System Replication on Azure VMs using Azure CLI (preview)](/azure/backup/quick-backup-hana-cli)
...
|  | [Quickstart: Restore SAP HANA System Replication on Azure VMs using Azure CLI (preview)](/azure/backup/quick-restore-hana-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az cognitiveservices account](/cli/azure/cognitiveservices/account) | [Configure Azure Cognitive Services virtual networks](/azure/cognitive-services/cognitive-services-virtual-networks)
...
|  | [Jobs in Azure Container Apps (preview)](/azure/container-apps/jobs)
...
|  | [Use Azure CLI to create a API for Cassandra account, keyspace, and table with autoscale](/azure/cosmos-db/scripts/cli/cassandra/autoscale)
|  | [Throughput (RU/s) operations with Azure CLI for a keyspace or table for Azure Cosmos DB - API for Cassandra](/azure/cosmos-db/scripts/cli/cassandra/throughput)
|  | [Create and manage intra-account container copy jobs in Azure Cosmos DB (Preview)](/azure/cosmos-db/how-to-container-copy)
...
| [az cosmosdb gremlin database](/cli/azure/cosmosdb/gremlin/database) | [Restore a deleted container or database into same Azure Cosmos DB account (preview)](/azure/cosmos-db/how-to-restore-in-account-continuous-backup)
...
|  | [Configure managed identities with Azure Active Directory for your Azure Cosmos DB account](/azure/cosmos-db/how-to-setup-managed-identity)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az dataprotection backup-instance](/cli/azure/dataprotection/backup-instance) | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
...
|  | [Restore Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-restore-using-cli)
| [az dataprotection backup-policy](/cli/azure/dataprotection/backup-policy) | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
...
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
| [az dataprotection backup-vault](/cli/azure/dataprotection/backup-vault) | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
...
|  | [Azure CLI reference commands for Azure Data Share](/cli/azure/azure-cli-reference-for-data-share)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az dedicated-hsm](/cli/azure/dedicated-hsm) | [Troubleshooting the Azure Dedicated HSM service](/azure/dedicated-hsm/troubleshoot)
...
| [az devops wiki](/cli/azure/devops/wiki) | [Create a wiki for your project](/azure/devops/project/wiki/wiki-create-repo)
...
| [az devops wiki page](/cli/azure/devops/wiki/page) | [Create a wiki for your project](/azure/devops/project/wiki/wiki-create-repo)
|  | [Add and edit wiki pages](/azure/devops/project/wiki/add-edit-wiki)
|  | [Manage wikis with the CLI](/azure/devops/project/wiki/manage-wikis)
|  | [Restore a deleted wiki](/azure/devops/project/wiki/restore-deleted-wiki)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az feature](/cli/azure/feature) | [Access tiers for blob data](/azure/storage/blobs/access-tiers-overview)
|  | [Create and manage multiple node pools for a cluster in Azure Kubernetes Service (AKS)](/azure/aks/use-multiple-node-pools)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az identity](/cli/azure/identity) | [Use Key Vault references for App Service and Azure Functions](/azure/app-service/app-service-key-vault-references)
...
|  | [Troubleshoot Azure VM Image Builder](/azure/virtual-machines/linux/image-builder-troubleshoot)
...
|  | [Azure CLI reference commands for Azure Monitor](/cli/azure/azure-cli-reference-for-monitor)
...
|  | [Monitor AKS-hybrid cluster](/azure/operator-nexus/howto-monitor-aks-h-cluster)
...
|  | [Route web traffic based on the URL using the Azure CLI](/azure/application-gateway/tutorial-url-route-cli)
|  | [Customize Web Application Firewall rules using the Azure CLI](/azure/web-application-firewall/ag/application-gateway-customize-waf-rules-cli)
...
|  | [Deploy tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-deployment)
|  | [Sample: CNF deployment script](/azure/operator-nexus/template-cloud-native-network-function-deployment)
|  | [Sample: VNF deployment script](/azure/operator-nexus/template-virtualized-network-function-deployment)
...
|  | [Deploy tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-deployment)
|  | [Sample: VNF deployment script](/azure/operator-nexus/template-virtualized-network-function-deployment)
| [az networkcloud l3network](/cli/azure/networkcloud/l3network) | [Deploy tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-deployment)
|  | [Sample: VNF deployment script](/azure/operator-nexus/template-virtualized-network-function-deployment)
| [az networkcloud trunkednetwork](/cli/azure/networkcloud/trunkednetwork) | [Deploy tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-deployment)
| [az networkcloud virtualmachine](/cli/azure/networkcloud/virtualmachine) | [Deploy tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-deployment)
|  | [Prerequisites for deploying tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-prerequisites)
|  | [Sample: VNF deployment script](/azure/operator-nexus/template-virtualized-network-function-deployment)
...
|  | [Tutorial: Migrate Azure Database for PostgreSQL - Single Server to Flexible Server by using the Azure CLI](/azure/postgresql/migrate/how-to-migrate-single-to-flexible-cli)
...
|  | [Validating data encryption for Azure Database for PostgreSQL](/azure/postgresql/single-server/how-to-data-encryption-validation)
|  | [Create and manage read replicas from the Azure CLI, REST API](/azure/postgresql/single-server/how-to-read-replicas-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az purview account](/cli/azure/purview/account) | [Access control in the Microsoft Purview governance portal](/azure/purview/catalog-permissions)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az resource](/cli/azure/resource) | [Add and manage TLS/SSL certificates in Azure App Service](/azure/app-service/configure-ssl-certificate)
...
|  | [Quickstart: Configure single sign-on for applications using the Azure Spring Apps Enterprise plan](/azure/spring-apps/quickstart-configure-single-sign-on-enterprise)
|  | [Migrate an Azure Spring Apps Basic or Standard plan instance to the Enterprise plan](/azure/spring-apps/how-to-migrate-standard-tier-to-enterprise-tier)
|  | [How to enable your own persistent storage in Azure Spring Apps](/azure/spring-apps/how-to-custom-persistent-storage)
...
|  | [Restore a database in Azure SQL Managed Instance to a previous point in time](/azure/azure-sql/managed-instance/point-in-time-restore)
|  | [Manage Azure SQL Managed Instance long-term backup retention](/azure/azure-sql/managed-instance/long-term-backup-retention-configure)
...
|  | [Access Azure file shares using Azure Active Directory with Azure Files OAuth over REST (preview)](/azure/storage/files/authorize-oauth-rest)
|  | [Restore Azure file shares with the Azure CLI](/azure/backup/restore-afs-cli)
|  | [Manage and restore soft-deleted blobs](/azure/storage/blobs/soft-delete-blob-manage)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az tag](/cli/azure/tag) | [Enable Microsoft Defender for Storage (classic)](/azure/defender-for-cloud/defender-for-storage-classic-enable)
