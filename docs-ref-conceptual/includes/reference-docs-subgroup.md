...
|  | [How to find your Microsoft Entra tenant ID](/azure/active-directory/fundamentals/how-to-find-tenant)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az acr](/cli/azure/acr) | [Create a service principal using certificate-based authentication](/cli/azure/azure-cli-sp-tutorial-3)
|  | [What's new in .NET 8](/dotnet/core/whats-new/dotnet-8)
...
| [az ad sp](/cli/azure/ad/sp) | [Create a service principal using password-based authentication](/cli/azure/azure-cli-sp-tutorial-2)
|  | [Create a service principal using certificate-based authentication](/cli/azure/azure-cli-sp-tutorial-3)
|  | [Get an existing service principal](/cli/azure/azure-cli-sp-tutorial-4)
|  | [Reset credentials](/cli/azure/azure-cli-sp-tutorial-7)
...
| [az ad sp credential](/cli/azure/ad/sp/credential) | [Create a service principal using certificate-based authentication](/cli/azure/azure-cli-sp-tutorial-3)
|  | [Reset credentials](/cli/azure/azure-cli-sp-tutorial-7)
...
| [az ad user](/cli/azure/ad/user) | [Log in to a Windows virtual machine in Azure by using Microsoft Entra ID including passwordless](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-windows)
|  | [Assign a Key Vault access policy (legacy)](/azure/key-vault/general/assign-access-policy)
|  | [Tutorial: Connect to SQL Database from .NET App Service without secrets using a managed identity](/azure/app-service/tutorial-connect-msi-sql-database)
|  | [Log in to a Linux virtual machine in Azure by using Microsoft Entra ID and OpenSSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux)
...
| [az aks addon](/cli/azure/aks/addon) | [Use the Azure Key Vault Provider for Secrets Store CSI Driver in an Azure Kubernetes Service (AKS) cluster](/azure/aks/csi-secrets-store-driver)
|  | [Managed nginx ingress with the application routing add-on (preview)](/azure/aks/app-routing)
...
| [az arcdata dc](/cli/azure/arcdata/dc) | [Storage Configuration](/azure/azure-arc/data/storage-configuration)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az azurestackhci galleryimage](/cli/azure/azurestackhci/galleryimage) | [Create Azure Stack HCI VM image using Azure Marketplace images (preview)](/azure-stack/hci/manage/virtual-machine-image-azure-marketplace)
|  | [Uninstall Azure Arc VM management (preview)](/azure-stack/hci/manage/uninstall-arc-resource-bridge)
...
|  | [Save and manage MARS agent passphrase securely in Azure Key Vault (preview)](/azure/backup/save-backup-passphrase-securely-in-azure-key-vault)
...
| [az cosmosdb gremlin database](/cli/azure/cosmosdb/gremlin/database) | [Quickstart: Traverse vertices and edges with the Gremlin console and Azure Cosmos DB for Apache Gremlin](/azure/cosmos-db/gremlin/quickstart-console)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az dataprotection backup-instance](/cli/azure/dataprotection/backup-instance) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
...
| [az dataprotection backup-policy](/cli/azure/dataprotection/backup-policy) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
| [az dataprotection backup-policy retention-rule](/cli/azure/dataprotection/backup-policy/retention-rule) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
...
| [az dataprotection backup-policy trigger](/cli/azure/dataprotection/backup-policy/trigger) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
| [az dataprotection backup-vault](/cli/azure/dataprotection/backup-vault) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
| [az dataprotection job](/cli/azure/dataprotection/job) | [Back up Azure Kubernetes Service using Azure CLI (preview)](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
|  | [Restore Azure Blobs to point-in-time using Azure CLI](/azure/backup/restore-blobs-storage-account-cli)
|  | [Restore Azure Managed Disks using Azure CLI](/azure/backup/restore-managed-disks-cli)
...
|  | [Configure networking for an Elastic SAN Preview](/azure/storage/elastic-san/elastic-san-networking)
...
| [az eventgrid system-topic](/cli/azure/eventgrid/system-topic) | [Subscribe to events raised by Azure Resource Notifications - Health Resources system topic](/azure/event-grid/subscribe-to-resource-notifications-health-resources-events)
...
|  | [Subscribe to events raised by Azure Resource Notifications - Health Resources system topic](/azure/event-grid/subscribe-to-resource-notifications-health-resources-events)
|  | [Tutorial: Route policy state change events to Event Grid with Azure CLI](/azure/governance/policy/tutorials/route-state-change-events)
|  | [MQTT Clients Life Cycle Events](/azure/event-grid/mqtt-client-life-cycle-events)
|  | [Create, view, and manage Event Grid system topics using Azure CLI](/azure/event-grid/create-view-manage-system-topics-cli)
...
|  | [Automatically upgrade Azure Kubernetes Service cluster node operating system images](/azure/aks/auto-upgrade-node-image)
|  | [Configure an AKS cluster](/azure/aks/cluster-configuration)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az functionapp](/cli/azure/functionapp) | [Azure CLI persisted parameter](/cli/azure/param-persist-howto)
|  | [Tutorial: Use persisted parameters to simplify sequential Azure CLI commands](/cli/azure/param-persist-tutorial)
...
|  | [How to use variables in Azure CLI commands](/cli/azure/azure-cli-variables)
|  | [Work with Virtual Machines using the Azure CLI](/cli/azure/azure-cli-vm-tutorial-1)
|  | [How to manage Azure resource groups with the Azure CLI](/cli/azure/manage-azure-groups-azure-cli)
|  | [Azure CLI persisted parameter](/cli/azure/param-persist-howto)
...
| [az keyvault secret](/cli/azure/keyvault/secret) | [Create a service principal using certificate-based authentication](/cli/azure/azure-cli-sp-tutorial-3)
|  | [Get an existing service principal](/cli/azure/azure-cli-sp-tutorial-4)
|  | [Use the Azure Key Vault Provider for Secrets Store CSI Driver in an Azure Kubernetes Service (AKS) cluster](/azure/aks/csi-secrets-store-driver)
|  | [Azure Key Vault configuration provider in ASP.NET Core](/aspnet/core/security/key-vault-configuration)
|  | [Use Azure Key Vault secrets in Azure Pipelines](/azure/devops/pipelines/release/azure-key-vault)
...
|  | [Tutorial: Schedule updates on Dynamic scopes](/azure/update-center/tutorial-dynamic-grouping-for-scheduled-patching)
...
| [az managed-cassandra datacenter](/cli/azure/managed-cassandra/datacenter) | [Quickstart: Configure a hybrid cluster with Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/configure-hybrid-cluster)
|  | [How to enable LDAP authentication in Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/ldap)
|  | [Quickstart: Create an Azure Managed Instance for Apache Cassandra cluster using Azure CLI](/azure/managed-instance-apache-cassandra/create-cluster-cli)
|  | [Quickstart: Create a multi-region cluster with Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/create-multi-region-cluster)
...
|  | [Configure VMware Spring Cloud Gateway](/azure/spring-apps/how-to-configure-enterprise-spring-cloud-gateway)
|  | [Set up autoscale for applications](/azure/spring-apps/how-to-setup-autoscale)
| [az monitor data-collection rule](/cli/azure/monitor/data-collection/rule) | [Azure Monitor managed service for Prometheus remote write](/azure/azure-monitor/containers/prometheus-remote-write)
|  | [Monitor Nexus Kubernetes cluster](/azure/operator-nexus/howto-monitor-naks-cluster)
|  | [Azure Active Directory authorization proxy](/azure/azure-monitor/containers/prometheus-authorization-proxy)
...
| [az network application-gateway waf-policy custom-rule](/cli/azure/network/application-gateway/waf-policy/custom-rule) | [Create rate limiting custom rules for Application Gateway WAF v2 (preview)](/azure/web-application-firewall/ag/rate-limiting-configure)
| [az network application-gateway waf-policy custom-rule match-condition](/cli/azure/network/application-gateway/waf-policy/custom-rule/match-condition) | [Create rate limiting custom rules for Application Gateway WAF v2 (preview)](/azure/web-application-firewall/ag/rate-limiting-configure)
...
|  | [Create, change, enable, disable, or delete VNet flow logs using the Azure CLI](/azure/network-watcher/vnet-flow-logs-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az networkcloud baremetalmachine](/cli/azure/networkcloud/baremetalmachine) | [Troubleshoot bare metal machine issues using the `az networkcloud baremetalmachine run-data-extract` command](/azure/operator-nexus/howto-baremetal-run-data-extract)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az role assignment](/cli/azure/role/assignment) | [Manage service principal roles](/cli/azure/azure-cli-sp-tutorial-5)
|  | [Create a service principal using password-based authentication](/cli/azure/azure-cli-sp-tutorial-2)
...
|  | [Log in to a Windows virtual machine in Azure by using Microsoft Entra ID including passwordless](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-windows)
|  | [Elevate access to manage all Azure subscriptions and management groups](/azure/role-based-access-control/elevate-access-global-admin)
...
|  | [Create and load Search Index with .NET](/azure/search/tutorial-csharp-create-load-index)
|  | [Manage your Azure Cognitive Search service with the Azure CLI](/azure/search/search-manage-azure-cli)
|  | [Create and load Search Index with JavaScript](/azure/search/tutorial-javascript-create-load-index)
...
|  | [Manage your Azure Cognitive Search service with the Azure CLI](/azure/search/search-manage-azure-cli)
|  | [Create and load Search Index with JavaScript](/azure/search/tutorial-javascript-create-load-index)
| [az search service](/cli/azure/search/service) | [Quickstart: Deploy Cognitive Search service using Terraform](/azure/search/search-get-started-terraform)
|  | [Create and load Search Index with .NET](/azure/search/tutorial-csharp-create-load-index)
|  | [Manage your Azure Cognitive Search service with the Azure CLI](/azure/search/search-manage-azure-cli)
|  | [Create and load Search Index with JavaScript](/azure/search/tutorial-javascript-create-load-index)
...
|  | [Azure Service Bus client library for Python - version 7.11.2](/python/api/overview/azure/servicebus-readme)
...
| [az servicebus queue](/cli/azure/servicebus/queue) | [Enable dead lettering on message expiration for Azure Service Bus queues and subscriptions](/azure/service-bus-messaging/enable-dead-letter)
...
| [az spring app identity](/cli/azure/spring/app/identity) | [Migrate an application to use passwordless connections with Azure Database for PostgreSQL](/azure/developer/java/spring-framework/migrate-postgresql-to-passwordless-connection)
...
|  | [Tutorial: Authenticate client with Spring Cloud Gateway on Azure Spring Apps](/azure/spring-apps/tutorial-authenticate-client-with-gateway)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az ssh](/cli/azure/ssh) | [Log in to a Linux virtual machine in Azure by using Microsoft Entra ID and OpenSSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux)
|  | [How to connect using Secure Shell (SSH) and sign on to an Azure virtual machine running Windows](/azure/virtual-machines/windows/connect-ssh)
...
|  | [Create a resource using service principal](/cli/azure/azure-cli-sp-tutorial-6)
...
| [az vm extension](/cli/azure/vm/extension) | [Log in to a Windows virtual machine in Azure by using Microsoft Entra ID including passwordless](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-windows)
|  | [Manage Azure Monitor Agent](/azure/azure-monitor/agents/azure-monitor-agent-manage)
|  | [Log in to a Linux virtual machine in Azure by using Microsoft Entra ID and OpenSSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux)
|  | [How to connect using Secure Shell (SSH) and sign on to an Azure virtual machine running Windows](/azure/virtual-machines/windows/connect-ssh)
...
|  | [Add Azure Dedicated Host to an Azure Kubernetes Service (AKS) cluster](/azure/aks/use-azure-dedicated-hosts)
| [az vm identity](/cli/azure/vm/identity) | [Log in to a Linux virtual machine in Azure by using Microsoft Entra ID and OpenSSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux)
...
|  | [Use the Linux diagnostic extension 4.0 to monitor metrics and logs](/azure/virtual-machines/extensions/diagnostics-linux)
| [az vmss identity](/cli/azure/vmss/identity) | [Log in to a Linux virtual machine in Azure by using Microsoft Entra ID and OpenSSH](/azure/active-directory/devices/howto-vm-sign-in-azure-ad-linux)
|  | [Provide an identity to access the Azure Key Vault Provider for Secrets Store CSI Driver in Azure Kubernetes Service (AKS)](/azure/aks/csi-secrets-store-identity-access)
|  | [Use the Linux diagnostic extension 4.0 to monitor metrics and logs](/azure/virtual-machines/extensions/diagnostics-linux)
