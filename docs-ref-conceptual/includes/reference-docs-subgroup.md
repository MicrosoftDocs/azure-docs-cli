...
|  | [How-to use the Azure CLI in a Bash environment](/cli/azure/azure-cli-learn-bash)
...
|  | [Tutorial - Deploy an application to Azure Kubernetes Service (AKS)](/azure/aks/tutorial-kubernetes-deploy-application)
...
| [az acr cache](/cli/azure/acr/cache) | [Artifact cache in Azure Container Registry (Preview)](/azure/container-registry/container-registry-artifact-cache)
...
| [az acr credential-set](/cli/azure/acr/credential-set) | [Artifact cache in Azure Container Registry (Preview)](/azure/container-registry/container-registry-artifact-cache)
...
|  | [Tutorial: Deploy SAP Deployment Automation Framework for enterprise scale](/azure/sap/automation/tutorial)
...
|  | [Control access using Microsoft Entra ID and Kubernetes RBAC in AKS enabled by Azure Arc](/azure/aks/hybrid/kubernetes-rbac-23h2)
...
|  | [Core Kubernetes concepts for Azure Kubernetes Service (AKS)](/azure/aks/concepts-clusters-workloads)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az aksarc](/cli/azure/aksarc) | [Control access using Microsoft Entra ID and Kubernetes RBAC in AKS enabled by Azure Arc](/azure/aks/hybrid/kubernetes-rbac-23h2)
...
| [az aksarc release](/cli/azure/aksarc/release) | [Use manual (offline) download in AKS enabled by Azure Arc (preview)](/azure/aks/hybrid/offline-download)
...
|  | [Migrate a non-VNet-injected API Management instance to the stv2 compute platform](/azure/api-management/migrate-stv1-to-stv2-no-vnet)
...
|  | [Quickstart: Deploy Azure IoT Operations Preview to an Arc-enabled Kubernetes cluster](/azure/iot-operations/get-started/quickstart-deploy)
|  | [Control access using Microsoft Entra ID and Kubernetes RBAC for Windows Server](/azure/aks/hybrid/kubernetes-rbac-entra-id)
|  | [Control access using Microsoft Entra ID and Kubernetes RBAC in AKS enabled by Azure Arc](/azure/aks/hybrid/kubernetes-rbac-23h2)
|  | [Use Azure role-based access control (RBAC) for Kubernetes authorization](/azure/aks/hybrid/azure-rbac-23h2)
|  | [Use cluster connect to securely connect to Azure Arc-enabled Kubernetes clusters](/azure/azure-arc/kubernetes/cluster-connect)
...
| [az containerapp env certificate](/cli/azure/containerapp/env/certificate) | [Import certificates from Azure Key Vault to Azure Container Apps (preview)](/azure/container-apps/key-vault-certificates-manage)
...
| [az containerapp sessionpool](/cli/azure/containerapp/sessionpool) | [Tutorial: Use code interpreter sessions in LlamaIndex with Azure Container Apps](/azure/container-apps/sessions-tutorial-llamaindex)
|  | [Serverless code interpreter sessions in Azure Container Apps (preview)](/azure/container-apps/sessions-code-interpreter)
|  | [Tutorial: Use code interpreter sessions in LangChain with Azure Container Apps](/azure/container-apps/sessions-tutorial-langchain)
|  | [Tutorial: Use code interpreter sessions in Semantic Kernel with Azure Container Apps](/azure/container-apps/sessions-tutorial-semantic-kernel)
...
|  | [Create Azure Stack HCI VM image using images in a local share](/azure-stack/hci/manage/virtual-machine-image-local-share)
|  | [Configuration of Azure Monitor edge pipeline](/azure/azure-monitor/essentials/edge-pipeline-configure)
|  | [Set up an Azure Arc-enabled Kubernetes cluster to run App Service, Functions, and Logic Apps (Preview)](/azure/app-service/manage-create-arc-environment)
|  | [Create Azure Stack HCI VM image using image in Azure Storage account](/azure-stack/hci/manage/virtual-machine-image-storage-account)
...
|  | [Self-hosted integration runtime auto-update and expire notification](/azure/data-factory/self-hosted-integration-runtime-auto-update)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az dedicated-hsm](/cli/azure/dedicated-hsm) | [Tutorial: Create a payment HSM](/azure/payment-hsm/create-payment-hsm)
...
|  | [Set up Start VM on Connect](/azure/virtual-desktop/start-virtual-machine-connect)
...
|  | [Tutorial: Deploy environments in CI/CD by using Azure Pipelines](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-azure-devops)
...
|  | [Tutorial: Configure MQTT bridge between Azure IoT MQ Preview and Azure Event Grid](/azure/iot-operations/connect-to-cloud/tutorial-connect-event-grid)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az hpc-cache](/cli/azure/hpc-cache) | [Create an Azure HPC Cache](/azure/hpc-cache/hpc-cache-create)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az image](/cli/azure/image) | [How to use Packer to create Linux virtual machine images in Azure](/azure/virtual-machines/linux/build-image-with-packer)
...
| [az iot ops](/cli/azure/iot/ops) | [Quickstart: Deploy Azure IoT Operations Preview to an Arc-enabled Kubernetes cluster](/azure/iot-operations/get-started/quickstart-deploy)
|  | [Prepare your Azure Arc-enabled Kubernetes cluster](/azure/iot-operations/deploy-iot-ops/howto-prepare-cluster)
|  | [Deploy Azure IoT Operations Preview extensions to a Kubernetes cluster](/azure/iot-operations/deploy-iot-ops/howto-deploy-iot-operations)
...
| [az iot ops mq](/cli/azure/iot/ops/mq) | [Configure Azure IoT MQ Preview authentication](/azure/iot-operations/manage-mqtt-connectivity/howto-configure-authentication)
...
|  | [Tutorial: Deploy applications using GitOps with Flux v2](/azure/azure-arc/kubernetes/tutorial-use-gitops-flux2)
|  | [Configure data collection and cost optimization in Container insights using data collection rule](/azure/azure-monitor/containers/container-insights-data-collection-dcr)
...
|  | [Use an Azure Resource Manager template to create a workspace for Azure Machine Learning](/azure/machine-learning/how-to-create-workspace-template)
|  | [Manage Key Vault using the Azure CLI](/azure/key-vault/general/manage-with-cli2)
|  | [Add Key Management Service etcd encryption to an Azure Kubernetes Service cluster](/azure/aks/use-kms-etcd-encryption)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az mariadb server](/cli/azure/mariadb/server) | [Quickstart: Create an Azure Database for MariaDB server by using the Azure CLI](/azure/mariadb/quickstart-create-mariadb-server-database-using-azure-cli)
...
|  | [Install & use the CLI (v1)](/azure/machine-learning/v1/reference-azure-machine-learning-cli)
|  | [Deploy a model to Azure Container Instances with CLI (v1)](/azure/machine-learning/v1/how-to-deploy-azure-container-instance)
...
|  | [Create virtual machines in a scale set using Azure CLI](/azure/virtual-machine-scale-sets/flexible-virtual-machine-scale-sets-cli)
...
|  | [Configure VMware Spring Cloud Gateway](/azure/spring-apps/enterprise/how-to-configure-enterprise-spring-cloud-gateway)
|  | [Set up autoscale for applications](/azure/spring-apps/enterprise/how-to-setup-autoscale)
| [az monitor data-collection endpoint](/cli/azure/monitor/data-collection/endpoint) | [Configuration of Azure Monitor edge pipeline](/azure/azure-monitor/essentials/edge-pipeline-configure)
| [az monitor data-collection rule](/cli/azure/monitor/data-collection/rule) | [Create and edit data collection rules (DCRs) in Azure Monitor](/azure/azure-monitor/essentials/data-collection-rule-create-edit)
...
|  | [View data collection rules in Azure Monitor](/azure/azure-monitor/essentials/data-collection-rule-view)
...
| [az monitor log-analytics workspace](/cli/azure/monitor/log-analytics/workspace) | [Data retention and archive in Azure Monitor Logs](/azure/azure-monitor/logs/data-retention-archive)
...
|  | [SSL offloading with Application Gateway for Containers - Ingress API](/azure/application-gateway/for-containers/how-to-ssl-offloading-ingress-api)
...
|  | [High availability of SAP HANA scale-up with Azure NetApp Files on SUSE Enterprise Linux](/azure/sap/workloads/sap-hana-high-availability-netapp-files-suse)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az network-analytics data-product](/cli/azure/network-analytics/data-product) | [Deploy an Azure Operator Insights Data Product](/azure/operator-insights/data-product-create)
...
|  | [Use Spring Data R2DBC with Azure Database for PostgreSQL](/azure/developer/java/spring-framework/configure-spring-data-r2dbc-with-azure-postgresql)
|  | [Quickstart: Integrate with Azure Database for PostgreSQL and Azure Cache for Redis](/azure/spring-apps/enterprise/quickstart-integrate-azure-database-and-redis-enterprise)
| [az postgres flexible-server migration](/cli/azure/postgres/flexible-server/migration) | [Premigration validations for the migrations service in Azure Database for PostgreSQL](/azure/postgresql/migrate/migration-service/concepts-premigration-migration-service)
...
|  | [Troubleshoot Azure Quantum](/azure/quantum//azure-quantum-common-issues)
...
|  | [Step 2 - Create and load Search Index with .NET](/azure/search/tutorial-csharp-create-load-index)
|  | [Manage your Azure AI Search service with the Azure CLI](/azure/search/search-manage-azure-cli)
...
|  | [Step 2 - Create and load Search Index with .NET](/azure/search/tutorial-csharp-create-load-index)
|  | [Manage your Azure AI Search service with the Azure CLI](/azure/search/search-manage-azure-cli)
| [az search service](/cli/azure/search/service) | [2 - Create and load Search Index with JavaScript](/azure/search/tutorial-javascript-create-load-index)
|  | [Step 2 - Create and load Search Index with .NET](/azure/search/tutorial-csharp-create-load-index)
...
| [az servicebus namespace](/cli/azure/servicebus/namespace) | [Tutorial - Use PaaS services with an Azure Kubernetes Service (AKS) cluster](/azure/aks/tutorial-kubernetes-paas-services)
...
| [az spring app identity](/cli/azure/spring/app/identity) | [Migrate an application to use passwordless connections with Azure Cosmos DB for NoSQL](/azure/cosmos-db/nosql/migrate-passwordless)
|  | [Migrate an application to use passwordless connections with Azure Blob Storage](/azure/storage/common/migrate-azure-credentials)
|  | [Migrate a Python application to use passwordless connections with Azure SQL Database](/azure/azure-sql/database/azure-sql-passwordless-migration-python)
|  | [Migrate an application to use passwordless connections with Azure Database for PostgreSQL](/azure/developer/java/spring-framework/migrate-postgresql-to-passwordless-connection)
|  | [Enable system-assigned managed identity for an application in Azure Spring Apps](/azure/spring-apps/enterprise/how-to-enable-system-assigned-managed-identity)
...
| [az sql db-arc backups-policy](/cli/azure/sql/db-arc/backups-policy) | [Manage automated backups - SQL Server enabled by Azure Arc (preview)](/sql/sql-server/azure-arc/backup-local)
...
|  | [Rotate the Transparent data encryption (TDE) protector](/azure/azure-sql/database/transparent-data-encryption-byok-key-rotation)
|  | [Remove a Transparent Data Encryption (TDE) protector using PowerShell](/azure/azure-sql/database/transparent-data-encryption-byok-remove-tde-protector)
| [az sql server-arc backups-policy](/cli/azure/sql/server-arc/backups-policy) | [Manage automated backups - SQL Server enabled by Azure Arc (preview)](/sql/sql-server/azure-arc/backup-local)
...
|  | [Prepare Ubuntu image for Azure Stack HCI virtual machines](/azure-stack/hci/manage/virtual-machine-image-linux-sysprep)
|  | [Create Azure Stack HCI VM image using images in a local share](/azure-stack/hci/manage/virtual-machine-image-local-share)
|  | [Create Azure Stack HCI VM image using image in Azure Storage account](/azure-stack/hci/manage/virtual-machine-image-storage-account)
|  | [Prepare Red Hat Enterprise image for Azure Stack HCI virtual machines (preview)](/azure-stack/hci/manage/virtual-machine-image-red-hat-enterprise)
|  | [Prepare CentOS Linux image for Azure Stack HCI virtual machines (preview)](/azure-stack/hci/manage/virtual-machine-image-centos)
| [az stack-hci-vm network lnet](/cli/azure/stack-hci-vm/network/lnet) | [Create Kubernetes clusters using Azure CLI](/azure/aks/hybrid/aks-create-clusters-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az storage account](/cli/azure/storage/account) | [How-to use the Azure CLI in a Bash environment](/cli/azure/azure-cli-learn-bash)
|  | [Considerations for running the Azure CLI in a PowerShell environment](/cli/azure/use-azure-cli-successfully-in-powershell)
|  | [How to use variables in Azure CLI commands](/cli/azure/azure-cli-variables)
|  | [How to manage Azure resource groups with the Azure CLI](/cli/azure/manage-azure-groups-azure-cli)
|  | [Learn Azure CLI syntax differences in Bash, PowerShell and Cmd](/cli/azure/get-started-tutorial-2-environment-syntax)
...
| [az storage account keys](/cli/azure/storage/account/keys) | [How-to use the Azure CLI in a Bash environment](/cli/azure/azure-cli-learn-bash)
|  | [Create a resource using a service principal](/cli/azure/azure-cli-sp-tutorial-6)
...
| [az storage blob](/cli/azure/storage/blob) | [How-to use the Azure CLI in a Bash environment](/cli/azure/azure-cli-learn-bash)
|  | [Deploy and score a machine learning model by using an online endpoint](/azure/machine-learning/how-to-deploy-online-endpoints)
|  | [Troubleshooting online endpoints deployment and scoring](/azure/machine-learning/how-to-troubleshoot-online-endpoints)
...
| [az storage container metadata](/cli/azure/storage/container/metadata) | [How-to use the Azure CLI in a Bash environment](/cli/azure/azure-cli-learn-bash)
...
|  | [Troubleshoot Resource Manager deployment issues with creating a new Linux virtual machine in Azure](/troubleshoot/azure/virtual-machines/linux/troubleshoot-deployment-new-vm-linux)
...
|  | [Quickstart: Create and encrypt a Linux VM with the Azure CLI](/azure/virtual-machines/linux/disk-encryption-cli-quickstart)
...
|  | [Send Prometheus metrics from Virtual Machines to an Azure Monitor workspace](/azure/azure-monitor/essentials/prometheus-remote-write-virtual-machines)
