...
|---|---|
| [az account](/cli/azure/account) | [Get started with Azure CLI](/cli/azure/get-started-with-azure-cli)
...
| [az acr artifact-streaming](/cli/azure/acr/artifact-streaming) | [Artifact Streaming - Azure CLI](/azure/container-registry/tutorial-artifact-streaming-cli)
...
|  | [Deploy the control plane](/azure/sap/automation/deploy-control-plane)
...
|  | [Sign container images with Notation and Azure Key Vault using a CA-issued certificate (Preview)](/azure/container-registry/container-registry-tutorial-sign-trusted-ca)
...
|  | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
...
|  | [Use an Azure DNS zone with SSL/TLS certificates from Azure Key Vault with the application routing add-on](/azure/aks/app-routing-dns-ssl)
|  | [Migrate from HTTP application routing to the application routing add-on](/azure/aks/app-routing-migration)
| [az aks approuting zone](/cli/azure/aks/approuting/zone) | [Use an Azure DNS zone with SSL/TLS certificates from Azure Key Vault with the application routing add-on](/azure/aks/app-routing-dns-ssl)
...
| [az aosm nfd](/cli/azure/aosm/nfd) | [Use Azure Operator Service Manager (AOSM) CLI extension](/azure/operator-service-manager/how-to-use-azure-operator-service-manager-cli-extension)
|  | [Quickstart: Complete the prerequisites to deploy a Containerized Network Function in Azure Operator Service Manager](/azure/operator-service-manager/quickstart-containerized-network-function-prerequisites)
...
|  | [Create a Ruby on Rails App in App Service](/azure/app-service/quickstart-ruby)
...
|  | [How to install AKS service on Azure Stack HCI alongside Arc VMs](/azure/aks/hybrid/deploy-aks-service-hci)
...
| [az arcappliance create](/cli/azure/arcappliance/create) | [How to install Arc Resource Bridge on Windows Server using the command line](/azure/aks/hybrid/deploy-arc-resource-bridge-windows-server)
|  | [Quickstart: Using Azure CLI to deploy an AKS hybrid cluster on a Windows Server node in an Azure VM](/azure/aks/hybrid/aks-hybrid-preview-azure-vm)
| [az arcappliance delete](/cli/azure/arcappliance/delete) | [Troubleshooting and known issues](/azure/aks/hybrid/troubleshoot-aks-hybrid-preview)
|  | [Remove your VMware vCenter  environment from Azure Arc](/azure/azure-arc/vmware-vsphere/remove-vcenter-from-arc-vmware)
| [az arcappliance deploy](/cli/azure/arcappliance/deploy) | [How to install Arc Resource Bridge on Windows Server using the command line](/azure/aks/hybrid/deploy-arc-resource-bridge-windows-server)
|  | [Quickstart: Using Azure CLI to deploy an AKS hybrid cluster on a Windows Server node in an Azure VM](/azure/aks/hybrid/aks-hybrid-preview-azure-vm)
...
| [az arcappliance validate](/cli/azure/arcappliance/validate) | [How to install Arc Resource Bridge on Windows Server using the command line](/azure/aks/hybrid/deploy-arc-resource-bridge-windows-server)
|  | [Quickstart: Using Azure CLI to deploy an AKS hybrid cluster on a Windows Server node in an Azure VM](/azure/aks/hybrid/aks-hybrid-preview-azure-vm)
...
|  | [How to create and manage LUIS resources](/azure/ai-services/LUIS/luis-how-to-azure-subscription)
...
|  | [Configure level 3 cluster in an isolated network](/azure/iot-operations/manage-layered-network/howto-configure-l3-cluster-layered-network)
|  | [Quickstart: Prerequisites for Operator and Containerized Network Function (CNF)](/azure/operator-service-manager/quickstart-containerized-network-function-operator)
...
|  | [Deploy Azure IoT Layered Network Management to an AKS cluster](/azure/iot-operations/manage-layered-network/howto-deploy-aks-layered-network)
|  | [Configure level 3 cluster in an isolated network](/azure/iot-operations/manage-layered-network/howto-configure-l3-cluster-layered-network)
|  | [Configure Azure IoT Layered Network Management on level 4 cluster](/azure/iot-operations/manage-layered-network/howto-configure-l4-cluster-layered-network)
|  | [Quickstart: Deploy Azure IoT Operations to an Arc-enabled Kubernetes cluster](/azure/iot-operations/get-started/quickstart-deploy)
|  | [Quickstart: Prerequisites for Operator and Containerized Network Function (CNF)](/azure/operator-service-manager/quickstart-containerized-network-function-operator)
|  | [Prepare your Azure Arc-enabled Kubernetes cluster](/azure/iot-operations/deploy-iot-ops/howto-prepare-cluster)
|  | [Set up an Azure Arc-enabled Kubernetes cluster to run App Service, Functions, and Logic Apps (Preview)](/azure/app-service/manage-create-arc-environment)
...
|  | [Configure Azure Arc-enabled SQL Server](/sql/sql-server/azure-arc/manage-configuration)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az connectedvmware vcenter](/cli/azure/connectedvmware/vcenter) | [Remove your VMware vCenter  environment from Azure Arc](/azure/azure-arc/vmware-vsphere/remove-vcenter-from-arc-vmware)
...
| [az containerapp env workload-profile](/cli/azure/containerapp/env/workload-profile) | [Tutorial: Connect to a Qdrant vector database in Azure Container Apps (preview)](/azure/container-apps/add-ons-qdrant)
|  | [Manage workload profiles with the Azure CLI](/azure/container-apps/workload-profiles-manage-cli)
...
| [az containerapp ingress cors](/cli/azure/containerapp/ingress/cors) | [Tutorial: Connect to a Qdrant vector database in Azure Container Apps (preview)](/azure/container-apps/add-ons-qdrant)
|  | [Configure cross-origin resource sharing (CORS) for Azure Container Apps](/azure/container-apps/cors)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az customlocation](/cli/azure/customlocation) | [Quickstart: Prerequisites for Operator and Containerized Network Function (CNF)](/azure/operator-service-manager/quickstart-containerized-network-function-operator)
...
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
| [az dataprotection backup-vault](/cli/azure/dataprotection/backup-vault) | [Back up Azure Kubernetes Service using Azure CLI](/azure/backup/azure-kubernetes-service-cluster-backup-using-cli)
|  | [Back up Azure PostgreSQL databases using Azure CLI](/azure/backup/backup-postgresql-cli)
|  | [Back up Azure Blobs in a storage account using Azure CLI](/azure/backup/backup-blobs-storage-account-cli)
|  | [Back up Azure Managed Disks using Azure CLI](/azure/backup/backup-managed-disks-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az devcenter admin catalog](/cli/azure/devcenter/admin/catalog) | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
...
| [az devcenter admin devcenter](/cli/azure/devcenter/admin/devcenter) | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
|  | [Create and configure a dev center for Azure Deployment Environments by using the Azure CLI](/azure/deployment-environments/how-to-create-configure-dev-center)
|  | [Create and configure a project by using the Azure CLI](/azure/deployment-environments/how-to-create-configure-projects)
| [az devcenter admin environment-type](/cli/azure/devcenter/admin/environment-type) | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
|  | [Create and configure a dev center for Azure Deployment Environments by using the Azure CLI](/azure/deployment-environments/how-to-create-configure-dev-center)
| [az devcenter admin project](/cli/azure/devcenter/admin/project) | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
|  | [Create and configure a project by using the Azure CLI](/azure/deployment-environments/how-to-create-configure-projects)
...
| [az devcenter admin project-environment-type](/cli/azure/devcenter/admin/project-environment-type) | [Tutorial: Deploy environments in CI/CD with GitHub and Azure Deployment Environments](/azure/deployment-environments/tutorial-deploy-environments-in-cicd-github)
|  | [Create and configure a project by using the Azure CLI](/azure/deployment-environments/how-to-create-configure-projects)
...
| [az devcenter dev environment](/cli/azure/devcenter/dev/environment) | [Add and configure an environment definition in Azure Deployment Environments](/azure/deployment-environments/configure-environment-definition)
...
| [az elastic-san volume](/cli/azure/elastic-san/volume) | [Snapshot Azure Elastic SAN Preview volumes](/azure/storage/elastic-san/elastic-san-snapshots)
|  | [Deploy an Elastic SAN Preview](/azure/storage/elastic-san/elastic-san-create)
...
|  | [Custom delivery properties](/azure/event-grid/delivery-properties)
| [az eventgrid namespace](/cli/azure/eventgrid/namespace) | [Publish and deliver events using namespace topics (preview)](/azure/event-grid/publish-deliver-events-with-namespace-topics)
...
|  | [Quickstart: Publish and subscribe to MQTT messages on Event Grid Namespace with Azure CLI](/azure/event-grid/mqtt-publish-and-subscribe-cli)
|  | [Tutorial: Route MQTT messages to Azure Event Hubs from Azure Event Grid with Azure CLI](/azure/event-grid/mqtt-routing-to-event-hubs-cli)
| [az eventgrid namespace client](/cli/azure/eventgrid/namespace/client) | [Quickstart: Publish and subscribe to MQTT messages on Event Grid Namespace with Azure CLI](/azure/event-grid/mqtt-publish-and-subscribe-cli)
| [az eventgrid namespace permission-binding](/cli/azure/eventgrid/namespace/permission-binding) | [Quickstart: Publish and subscribe to MQTT messages on Event Grid Namespace with Azure CLI](/azure/event-grid/mqtt-publish-and-subscribe-cli)
| [az eventgrid namespace topic-space](/cli/azure/eventgrid/namespace/topic-space) | [Tutorial: Configure MQTT bridge between IoT MQ and Azure Event Grid](/azure/iot-operations/send-view-analyze-data/tutorial-connect-event-grid)
|  | [Quickstart: Publish and subscribe to MQTT messages on Event Grid Namespace with Azure CLI](/azure/event-grid/mqtt-publish-and-subscribe-cli)
...
| [az eventgrid system-topic](/cli/azure/eventgrid/system-topic) | [Subscribe to Azure Resource Management events in Event Grid (Preview)](/azure/event-grid/subscribe-to-resource-notifications-resources-events)
...
|  | [Map custom fields to Event Grid schema](/azure/event-grid/input-mappings)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az eventhubs eventhub](/cli/azure/eventhubs/eventhub) | [Publish and deliver events using namespace topics (preview)](/azure/event-grid/publish-deliver-events-with-namespace-topics)
...
| [az eventhubs namespace](/cli/azure/eventhubs/namespace) | [Quickstart: Subscribe to Azure Kubernetes Service (AKS) events with Azure Event Grid](/azure/aks/quickstart-event-grid)
|  | [Quickstart: Route custom events to Azure Event Hubs with Azure CLI and Event Grid](/azure/event-grid/custom-event-to-eventhub)
|  | [Quickstart: Create an event hub using Azure CLI](/azure/event-hubs/event-hubs-quickstart-cli)
|  | [Grant managed identity the access to Event Grid destination](/azure/event-grid/add-identity-roles)
|  | [Tutorial: Create a function in Java with an Event Hub trigger and an Azure Cosmos DB output binding](/azure/azure-functions/functions-event-hub-cosmos-db)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az feature](/cli/azure/feature) | [Auto-upgrade Azure Kubernetes Service cluster node OS images](/azure/aks/auto-upgrade-node-image)
...
| [az feature registration](/cli/azure/feature/registration) | [Quickstart: Create an Azure Managed CCF resource using the Azure SDK for Go](/azure/managed-ccf/quickstart-go)
...
|  | [Update Java versions in Azure Functions](/azure/azure-functions/update-java-versions)
...
|  | [Configure a custom container for Azure App Service](/azure/app-service/configure-custom-container)
|  | [Migrate custom software to Azure App Service using a custom container](/azure/app-service/tutorial-custom-container)
|  | [Provide an identity to access the Azure Key Vault provider for Secrets Store CSI Driver in Azure Kubernetes Service (AKS)](/azure/aks/csi-secrets-store-identity-access)
...
| [az identity federated-credential](/cli/azure/identity/federated-credential) | [Provide an identity to access the Azure Key Vault provider for Secrets Store CSI Driver in Azure Kubernetes Service (AKS)](/azure/aks/csi-secrets-store-identity-access)
...
| [az k8s-configuration flux kustomization](/cli/azure/k8s-configuration/flux/kustomization) | [Application deployments with GitOps (Flux v2) for AKS and Azure Arc-enabled Kubernetes](/azure/azure-arc/kubernetes/conceptual-gitops-flux2)
...
|  | [How to enable Microsoft Defender for Containers components](/azure/defender-for-cloud/defender-for-containers-enable)
|  | [Tutorial: Deploy applications using GitOps with Flux v2](/azure/azure-arc/kubernetes/tutorial-use-gitops-flux2)
|  | [Application deployments with GitOps (Flux v2) for AKS and Azure Arc-enabled Kubernetes](/azure/azure-arc/kubernetes/conceptual-gitops-flux2)
...
|  | [Connect MQTT bridge cloud connector to other MQTT brokers](/azure/iot-operations/connect-to-cloud/howto-configure-mqtt-bridge)
|  | [Configure Azure IoT Layered Network Management on level 4 cluster](/azure/iot-operations/manage-layered-network/howto-configure-l4-cluster-layered-network)
|  | [Deploy Azure IoT Layered Network Management to an AKS cluster](/azure/iot-operations/manage-layered-network/howto-deploy-aks-layered-network)
|  | [Quickstart: Prerequisites for Operator and Containerized Network Function (CNF)](/azure/operator-service-manager/quickstart-containerized-network-function-operator)
...
| [az managed-cassandra datacenter](/cli/azure/managed-cassandra/datacenter) | [Quickstart: Configure a hybrid cluster with Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/configure-hybrid-cluster-cli)
|  | [How to enable LDAP authentication in Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/ldap)
|  | [Quickstart: Create an Azure Managed Instance for Apache Cassandra cluster using Azure CLI](/azure/managed-instance-apache-cassandra/create-cluster-cli)
|  | [Quickstart: Create a multi-region cluster with Azure Managed Instance for Apache Cassandra](/azure/managed-instance-apache-cassandra/create-multi-region-cluster)
|  | [Manage Azure Managed Instance for Apache Cassandra resources using Azure CLI](/azure/managed-instance-apache-cassandra/manage-resources-cli)
...
|  | [Run OpenAI models in batch endpoints to compute embeddings](/azure/machine-learning/how-to-use-batch-model-openai-embeddings)
...
|  | [Troubleshooting online endpoints deployment and scoring](/azure/machine-learning/how-to-troubleshoot-online-endpoints)
|  | [Tutorial: Train an object detection model with AutoML and Python](/azure/machine-learning/tutorial-auto-train-image-models)
|  | [Deploy models from HuggingFace hub to Azure Machine Learning online endpoints for real-time inference (Preview)](/azure/machine-learning/how-to-deploy-models-from-huggingface)
|  | [Share models, components, and environments across workspaces with registries](/azure/machine-learning/how-to-share-models-pipelines-across-workspaces-with-registries)
|  | [Secure your managed online endpoints with network isolation](/azure/machine-learning/how-to-secure-online-endpoint)
|  | [Deploy MLflow models to online endpoints](/azure/machine-learning/how-to-deploy-mlflow-models-online-endpoints)
|  | [Set up AutoML to train computer vision models](/azure/machine-learning/how-to-auto-train-image-models)
...
|  | [Troubleshooting online endpoints deployment and scoring](/azure/machine-learning/how-to-troubleshoot-online-endpoints)
|  | [Key and token-based authentication for online endpoints](/azure/machine-learning/how-to-authenticate-online-endpoint)
|  | [Tutorial: Train an object detection model with AutoML and Python](/azure/machine-learning/tutorial-auto-train-image-models)
|  | [Deploy models from HuggingFace hub to Azure Machine Learning online endpoints for real-time inference (Preview)](/azure/machine-learning/how-to-deploy-models-from-huggingface)
|  | [Share models, components, and environments across workspaces with registries](/azure/machine-learning/how-to-share-models-pipelines-across-workspaces-with-registries)
|  | [Secure your managed online endpoints with network isolation](/azure/machine-learning/how-to-secure-online-endpoint)
...
|  | [View the application logs in Azure Monitor](/azure/managed-ccf/how-to-enable-azure-monitor)
...
|  | [Log storage and monitoring options in Azure Container Apps](/azure/container-apps/log-options)
|  | [Monitor Azure Cosmos DB for MongoDB vCore diagnostics logs with Azure Monitor](/azure/cosmos-db/mongodb/vcore/how-to-monitor-diagnostics-logs)
|  | [Enable private link with Container insights](/azure/azure-monitor/containers/container-insights-private-link)
|  | [Tutorial: Troubleshoot an App Service app with Azure Monitor](/azure/app-service/tutorial-troubleshoot-monitor)
...
|  | [Create metric alert monitors in Azure CLI](/azure/azure-monitor/alerts/azure-cli-metrics-alert-sample)
| [az monitor metrics alert condition](/cli/azure/monitor/metrics/alert/condition) | [Create metric alert monitors in Azure CLI](/azure/azure-monitor/alerts/azure-cli-metrics-alert-sample)
| [az monitor metrics alert dimension](/cli/azure/monitor/metrics/alert/dimension) | [Create metric alert monitors in Azure CLI](/azure/azure-monitor/alerts/azure-cli-metrics-alert-sample)
...
|  | [Migrate an application to use passwordless connections with Azure Database for MySQL](/azure/developer/java/spring-framework/migrate-mysql-to-passwordless-connection)
|  | [Configure passwordless database connections for Java apps on Oracle WebLogic Servers](/azure/developer/java/ee/how-to-configure-passwordless-datasource)
| [az mysql flexible-server import](/cli/azure/mysql/flexible-server/import) | [Migrate MySQL on-premises or Virtual Machine (VM) workload to Azure Database for MySQL - Flexible Server using Azure MySQL Import CLI](/azure/mysql/migrate/migrate-external-mysql-import-cli)
|  | [Migrate Azure Database for MySQL - Single Server to Flexible Server using Azure MySQL Import CLI](/azure/mysql/migrate/migrate-single-flexible-mysql-import-cli)
...
| [az network alb](/cli/azure/network/alb) | [Header rewrite for Azure Application Gateway for Containers - Ingress API (preview)](/azure/application-gateway/for-containers/how-to-header-rewrite-ingress-api)
|  | [URL Rewrite for Azure Application Gateway for Containers - Ingress API (preview)](/azure/application-gateway/for-containers/how-to-url-rewrite-ingress-api)
...
|  | [Set up Oracle ASM on an Azure Linux virtual machine](/azure/virtual-machines/workloads/oracle/configure-oracle-asm)
|  | [Tutorial: Configure dual stack outbound connectivity with a NAT gateway and a public load balancer](/azure/nat-gateway/tutorial-dual-stack-outbound-nat-load-balancer)
| [az network nsg rule](/cli/azure/network/nsg/rule) | [How to connect using Secure Shell (SSH) and sign on to an Azure virtual machine running Windows](/azure/virtual-machines/windows/connect-ssh)
...
|  | [Configure a private endpoint for an Azure Machine Learning workspace](/azure/machine-learning/how-to-configure-private-link)
|  | [Quickstart: Create a private endpoint by using the Azure CLI](/azure/private-link/create-private-endpoint-cli)
|  | [Use Private Link](/azure/notification-hubs/private-link)
...
|  | [Configure virtual network service endpoint policies for Azure HDInsight](/azure/hdinsight/service-endpoint-policies)
| [az network traffic-manager endpoint](/cli/azure/network/traffic-manager/endpoint) | [Quickstart: Create a Traffic Manager profile for a highly available web application using Azure CLI](/azure/traffic-manager/quickstart-create-traffic-manager-profile-cli)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az networkcloud baremetalmachine](/cli/azure/networkcloud/baremetalmachine) | [Working with placement hints in Azure Operator Nexus virtual machine](/azure/operator-nexus/howto-virtual-machine-placement-hints)
...
| [az networkcloud kubernetescluster](/cli/azure/networkcloud/kubernetescluster) | [Restart Azure Operator Nexus Kubernetes cluster node](/azure/operator-nexus/howto-kubernetes-cluster-action-restart)
|  | [Quickstart: Deploy an Azure Nexus Kubernetes cluster using Bicep](/azure/operator-nexus/quickstarts-kubernetes-cluster-deployment-bicep)
...
| [az networkfabric internalnetwork](/cli/azure/networkfabric/internalnetwork) | [Prerequisites for deploying tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-prerequisites)
...
| [az networkfabric l2domain](/cli/azure/networkfabric/l2domain) | [Prerequisites for deploying tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-prerequisites)
|  | [Configure L2 and L3 isolation-domains using managed network fabric services](/azure/operator-nexus/howto-configure-isolation-domain)
| [az networkfabric l3domain](/cli/azure/networkfabric/l3domain) | [Prerequisites for deploying tenant workloads](/azure/operator-nexus/quickstarts-tenant-workload-prerequisites)
|  | [Configure L2 and L3 isolation-domains using managed network fabric services](/azure/operator-nexus/howto-configure-isolation-domain)
...
| [az notification-hub namespace](/cli/azure/notification-hub/namespace) | [Use Private Link](/azure/notification-hubs/private-link)
|  | [Quickstart: Create a notification hub using a Resource Manager template](/azure/notification-hubs/create-notification-hub-template)
|  | [Quickstart: Create an Azure notification hub using the Azure CLI](/azure/notification-hubs/create-notification-hub-azure-cli)
...
|  | [Restore Azure Arc-enabled PostgreSQL servers](/azure/azure-arc/data/restore-postgresql)
...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az provider](/cli/azure/provider) | [Quickstart: Deploy your first application to Azure Spring Apps](/azure/spring-apps/quickstart)
...
|  | [Azure Service Bus client library for Python - version 7.11.4](/python/api/overview/azure/servicebus-readme)
...
|  | [How to configure planned maintenance (preview)](/azure/spring-apps/how-to-configure-planned-maintenance)
...
| [az spring gateway route-config](/cli/azure/spring/gateway/route-config) | [Quickstart: Integrate Azure OpenAI](/azure/spring-apps/quickstart-fitness-store-azure-openai)
...
|  | [Quickstart: Create an Azure SQL Database server and database using Terraform](/azure/azure-sql/database/single-database-create-terraform-quickstart)
...
| [az sql db-arc](/cli/azure/sql/db-arc) | [Restore to a point-in-time on Azure Arc-enabled SQL Server](/sql/sql-server/azure-arc/point-in-time-restore)
...
|  | [Connect to Azure Arc-enabled SQL Managed Instance](/azure/azure-arc/data/connect-managed-instance)
|  | [Create Azure Arc-enabled SQL Managed Instance using Azure Data Studio](/azure/azure-arc/data/create-sql-managed-instance-azure-data-studio)
|  | [Configure Azure Arc-enabled SQL managed instance](/azure/azure-arc/data/configure-managed-instance)
|  | [Quickstart: Deploy Azure Arc-enabled data services - indirectly connected mode - Azure CLI](/azure/azure-arc/data/create-complete-managed-instance-indirectly-connected)
...
|  | [Rotate the Transparent data encryption (TDE) protector](/azure/azure-sql/database/transparent-data-encryption-byok-key-rotation)
|  | [Remove a Transparent Data Encryption (TDE) protector using PowerShell](/azure/azure-sql/database/transparent-data-encryption-byok-remove-tde-protector)
| [az sql server-arc backups-policy](/cli/azure/sql/server-arc/backups-policy) | [Manage automated backups - Azure Arc-enabled SQL Server](/sql/sql-server/azure-arc/backup-local)
...
| [az stack-hci cluster](/cli/azure/stack-hci/cluster) | [Azure verification for VMs](/azure-stack/hci/deploy/azure-verification)
|  | [Azure Hybrid Benefit for Azure Stack HCI](/azure-stack/hci/concepts/azure-hybrid-benefit-hci)
|  | [License Windows Server VMs on Azure Stack HCI](/azure-stack/hci/manage/vm-activate)
|  | [Azure Benefits on Azure Stack HCI](/azure-stack/hci/manage/azure-benefits)
...
|  | [Tutorial: Access Azure Blob Storage using Azure Databricks and Azure Key Vault](/azure/key-vault/general/integrate-databricks-blob-storage)
...
|  | [Tutorial: Manually install IBM WebSphere Application Server Network Deployment traditional on Azure Virtual Machines](/azure/developer/java/migration/migrate-websphere-to-azure-vm-manually)
|  | [Create a public load balancer with IPv6 using Azure CLI](/azure/load-balancer/load-balancer-ipv6-internet-cli)
|  | [Tutorial: Configure availability groups for SQL Server on RHEL virtual machines in Azure](/azure/azure-sql/virtual-machines/linux/rhel-high-availability-stonith-tutorial)
|  | [Load balancing on multiple IP configurations using Azure CLI](/azure/load-balancer/load-balancer-multiple-ip-cli)
...
|  | [Add Azure Dedicated Host to an Azure Kubernetes Service (AKS) cluster](/azure/aks/use-azure-dedicated-hosts)
| [az vm identity](/cli/azure/vm/identity) | [Provide an identity to access the Azure Key Vault provider for Secrets Store CSI Driver in Azure Kubernetes Service (AKS)](/azure/aks/csi-secrets-store-identity-access)
...
|  | [Tutorial: Use Azure Key Vault with a virtual machine in Python](/azure/key-vault/general/tutorial-python-virtual-machine)
...
|  | [Tutorial: Install applications in Virtual Machine Scale Sets with the Azure CLI](/azure/virtual-machine-scale-sets/tutorial-install-apps-cli)
| [az vmss identity](/cli/azure/vmss/identity) | [Provide an identity to access the Azure Key Vault provider for Secrets Store CSI Driver in Azure Kubernetes Service (AKS)](/azure/aks/csi-secrets-store-identity-access)
|  | [Use the Linux diagnostic extension 4.0 to monitor metrics and logs](/azure/virtual-machines/extensions/diagnostics-linux)
...
| [az workloads sap-virtual-instance](/cli/azure/workloads/sap-virtual-instance) | [Soft stop SAP systems, application server instances and HANA database](/azure/sap/center-sap-solutions/soft-stop-sap-and-hana-database)
