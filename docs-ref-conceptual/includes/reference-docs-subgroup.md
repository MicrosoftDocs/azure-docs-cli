...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az akshybrid](/cli/azure/akshybrid) | [Manage multiple node pools in AKS Arc](/azure/aks/hybrid/manage-node-pools)
...
|  | [Create Kubernetes clusters using Azure CLI (preview)](/azure/aks/hybrid/aks-create-clusters-cli)
| [az akshybrid vnet](/cli/azure/akshybrid/vnet) | [Create networks for AKS (preview)](/azure/aks/hybrid/aks-networks)
