...
|Reference subgroup|Azure CLI article showing reference use
|---|---|
| [az acr](/cli/azure/acr) | [Create an unmanaged ingress controller](/azure/aks/ingress-basic)
...
|  | [Azure Kubernetes Service (AKS) ingress with the application routing add-on (preview)](/azure/aks/app-routing)
...
| [az network custom-ip prefix](/cli/azure/network/custom-ip/prefix) | [Create a custom IPv6 address prefix using Azure CLI](/azure/virtual-network/ip-services/create-custom-ip-address-prefix-ipv6-cli)
...
| [az signalr key](/cli/azure/signalr/key) | [Connection string in Azure SignalR Service](/azure/azure-signalr/concept-connection-string)
