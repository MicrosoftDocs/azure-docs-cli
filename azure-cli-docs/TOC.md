...
#### [az appservice web git](appservice\web\git.pycliyml)
...
## [az devops](devops.pycliyml)
### [az devops build](devops\build.pycliyml)
### [az devops release](devops\release.pycliyml)
## [az iot](iot.pycliyml)
