...
### [Container Registry credentials](acr\credential.pycliyml "az acr credential")
...
### [Container Registry repositories](acr\repository.pycliyml "az acr repository")
...
### [Container Service - DC/OS](acs\dcos.pycliyml "az acs dcos")
...
### [Container Service - Kubernetes](acs\kubernetes.pycliyml "az acs kubernetes")
...
## [Azure Active Directory (AAD)](ad.pycliyml "az ad")
### [AAD applications](ad\app.pycliyml "az ad app")
...
### [AAD groups](ad\group.pycliyml "az ad group")
...
### [AAD service principals](ad\sp.pycliyml "az ad sp")
...
### [AAD users](ad\user.pycliyml "az ad user")
...
### [App Service plans](appservice\plan.pycliyml "az appservice plan")
...
#### [Web Apps configuration](appservice\web\config.pycliyml "az appservice web config")
##### [Web Apps application settings](appservice\web\config\appsettings.pycliyml "az appservice web config appsettings")
...
##### [Web Apps container settings](appservice\web\config\container.pycliyml "az appservice web config container")
...
##### [Web Apps hostnames](appservice\web\config\hostname.pycliyml "az appservice web config hostname")
...
#### [Web Apps deployments](appservice\web\deployment.pycliyml "az appservice web deployment")
##### [az appservice web deployment list-site-credentials](appservice\web\deployment.pycliyml#list-site-credentials)
##### [Web Apps deployment slots](appservice\web\deployment\slot.pycliyml "az appservice web deployment slot")
...
##### [Web Apps deployment users](appservice\web\deployment\user.pycliyml "az appservice web deployment user")
...
#### [Web Apps logs](appservice\web\log.pycliyml "az appservice web log")
...
### [Batch accounts](batch\account.pycliyml "az batch account")
#### [Batch account auto-storage keys](batch\account\autostorage-keys.pycliyml "az batch account autostorage-keys")
...
#### [Batch account keys](batch\account\keys.pycliyml "az batch account keys")
...
### [Batch applications](batch\application.pycliyml "az batch application")
...
#### [Batch application packages](batch\application\package.pycliyml "az batch application package")
...
### [Batch locations](batch\location.pycliyml "az batch location")
#### [Batch location quotas](batch\location\quotas.pycliyml "az batch location quotas")
...
## [Could Services](cloud.pycliyml "az cloud")
...
### [Docker builds](container\build.pycliyml "az container build")
#### [az container build create](container\build.pycliyml#create)
### [Docker releases](container\release.pycliyml "az container release")
...
#### [Deployment operations](group\deployment\operation.pycliyml "az group deployment operation")
...
### [IoT devices](iot\device.pycliyml "az iot device")
...
#### [IoT device messaging](iot\device\message.pycliyml "az iot device message")
...
### [IoT hubs](iot\hub.pycliyml "az iot hub")
#### [IoT hub consumer groups](iot\hub\consumer-group.pycliyml "az iot hub consumer-group")
...
#### [IoT hub jobs](iot\hub\job.pycliyml "az iot hub job")
...
#### [IoT hub policies](iot\hub\policy.pycliyml "az iot hub policy")
...
### [Key vault certificates](keyvault\certificate.pycliyml "az keyvault certificate")
#### [Key vault certificate contacts](keyvault\certificate\contact.pycliyml "az keyvault certificate contact")
...
#### [Key vault certificate issuers](keyvault\certificate\issuer.pycliyml "az keyvault certificate issuer")
##### [Key vault certificate issuer administration](keyvault\certificate\issuer\admin.pycliyml "az keyvault certificate issuer admin")
...
#### [Pending key vault certificates](keyvault\certificate\pending.pycliyml "az keyvault certificate pending")
...
### [Key vault keys](keyvault\key.pycliyml "az keyvault key")
...
### [Key vault secrets](keyvault\secret.pycliyml "az keyvault secret")
...
#### [Application gateway probes](network\application-gateway\probe.pycliyml "az network application-gateway probe")
...
##### [URL path map rules](network\application-gateway\url-path-map\rule.pycliyml "az network application-gateway url-path-map rule")
...
### [DNS domains](network\dns.pycliyml "az network dns")
#### [DNS records](network\dns\record.pycliyml "az network dns record")
##### [DNS - A records](network\dns\record\a.pycliyml "az network dns record a")
...
##### [DNS - AAAA records](network\dns\record\aaaa.pycliyml "az network dns record aaaa")
...
##### [DNS - CNAME records](network\dns\record\cname.pycliyml "az network dns record cname")
...
##### [DNS - MX (mail) records](network\dns\record\mx.pycliyml "az network dns record mx")
...
##### [DNS - NS (nameserver) records](network\dns\record\ns.pycliyml "az network dns record ns")
###### [az network dns record ns add](network\dns\record\ns.pycliyml#add)
###### [az network dns record ns remove](network\dns\record\ns.pycliyml#remove)
##### [DNS - PTR (pointer) records](network\dns\record\ptr.pycliyml "az network dns record ptr")
...
##### [DNS - SRV records](network\dns\record\srv.pycliyml "az network dns record srv")
...
##### [DNS - TXT records](network\dns\record\txt.pycliyml "az network dns record txt")
...
#### [DNS - record sets](network\dns\record-set.pycliyml "az network dns record-set")
...
#### [DNS zones](network\dns\zone.pycliyml "az network dns zone")
...
#### [Express route circuit authentication](network\express-route\auth.pycliyml "az network express-route auth")
...
#### [Express route peering](network\express-route\peering.pycliyml "az network express-route peering")
...
#### [Load balancer probes](network\lb\probe.pycliyml "az network lb probe")
...
#### [Load balancing rules](network\lb\rule.pycliyml "az network lb rule")
...
### [Network traffic managers](network\traffic-manager.pycliyml "az network traffic-manager")
...
#### [Traffic manager profiles](network\traffic-manager\profile.pycliyml "az network traffic-manager profile")
...
#### [VPN shared keys](network\vpn-connection\shared-key.pycliyml "az network vpn-connection shared-key")
...
### [Resource policy assignments](policy\assignment.pycliyml "az policy assignment")
...
### [Resource policy definitions](policy\definition.pycliyml "az policy definition")
...
### [Role assignments](role\assignment.pycliyml "az role assignment")
...
### [Role definitions](role\definition.pycliyml "az role definition")
...
### [SQL Databases](sql\db.pycliyml "az sql db")
#### [az sql db create](sql\db.pycliyml#create)
#### [SQL data warehouses](sql\db\data-warehouse.pycliyml "az sql db data-warehouse")
...
#### [SQL replication links](sql\db\replication-link.pycliyml "az sql db replication-link")
...
#### [SQL restore points](sql\db\restore-point.pycliyml "az sql db restore-point")
##### [az sql db restore-point list](sql\db\restore-point.pycliyml#list)
#### [SQL service tier advisors](sql\db\service-tier-advisor.pycliyml "az sql db service-tier-advisor")
...
#### [SQL transparent data encryption](sql\db\transparent-data-encryption.pycliyml "az sql db transparent-data-encryption")
...
### [SQL Elastic pools](sql\elastic-pools.pycliyml "az sql elastic-pools")
#### [az sql elastic-pools create](sql\elastic-pools.pycliyml#create)
#### [SQL elastic pool database activity](sql\elastic-pools\db.pycliyml "az sql elastic-pools db")
...
#### [SQL recommended elastic pools](sql\elastic-pools\recommended.pycliyml "az sql elastic-pools recommended")
##### [SQL elastic pool database](sql\elastic-pools\recommended\db.pycliyml "az sql elastic-pools recommended db")
...
### [SQL Server](sql\server.pycliyml "az sql server")
#### [az sql server create](sql\server.pycliyml#create)
#### [az sql server delete](sql\server.pycliyml#delete)
#### [SQL Server firewalls](sql\server\firewall.pycliyml "az sql server firewall")
...
#### [SQL Server service objectives](sql\server\service-objective.pycliyml "az sql server service-objective")
...
### [Storage accounts](storage\account.pycliyml "az storage account")
...
#### [Storage accounts keys](storage\account\keys.pycliyml "az storage account keys")
...
### [Blob storage](storage\blob.pycliyml "az storage blob")
#### [Blob storage copy operations](storage\blob\copy.pycliyml "az storage blob copy")
...
#### [Blob storage leases](storage\blob\lease.pycliyml "az storage blob lease")
...
#### [Blob storage metadata](storage\blob\metadata.pycliyml "az storage blob metadata")
...
#### [Blob storage service properties](storage\blob\service-properties.pycliyml "az storage blob service-properties")
...
### [Storage containers](storage\container.pycliyml "az storage container")
...
#### [Storage container leases](storage\container\lease.pycliyml "az storage container lease")
...
#### [Storage container metadata](storage\container\metadata.pycliyml "az storage container metadata")
...
#### [Storage container policies](storage\container\policy.pycliyml "az storage container policy")
...
### [Storage directories](storage\directory.pycliyml "az storage directory")
...
#### [Directory metadata](storage\directory\metadata.pycliyml "az storage directory metadata")
...
#### [File copy operations](storage\file\copy.pycliyml "az storage file copy")
...
#### [File metadata](storage\file\metadata.pycliyml "az storage file metadata")
...
### [Storage service logging](storage\logging.pycliyml "az storage logging")
#### [az storage logging show](storage\logging.pycliyml#show)
#### [az storage logging update](storage\logging.pycliyml#update)
### [Storage messages](storage\message.pycliyml "az storage message")
...
### [Storage metrics](storage\metrics.pycliyml "az storage metrics")
#### [az storage metrics show](storage\metrics.pycliyml#show)
#### [az storage metrics update](storage\metrics.pycliyml#update)
### [Storage queues](storage\queue.pycliyml "az storage queue")
...
#### [Storage queue metadata](storage\queue\metadata.pycliyml "az storage queue metadata")
...
#### [Storage queue policies](storage\queue\policy.pycliyml "az storage queue policy")
...
#### [File share metadata](storage\share\metadata.pycliyml "az storage share metadata")
...
#### [File share policies](storage\share\policy.pycliyml "az storage share policy")
...
#### [Table policies](storage\table\policy.pycliyml "az storage table policy")
...
## [Virtual machines (VM)](vm.pycliyml "az vm")
### [VM user access](vm\access.pycliyml "az vm access")
...
### [VM availability sets](vm\availability-set.pycliyml "az vm availability-set")
...
### [VM boot diagnostics](vm\boot-diagnostics.pycliyml "az vm boot-diagnostics")
...
### [VM diagnostics](vm\diagnostics.pycliyml "az vm diagnostics")
...
### [VM storage disks](vm\disk.pycliyml "az vm disk")
#### [az vm disk attach](vm\disk.pycliyml#attach)
#### [az vm disk detach](vm\disk.pycliyml#detach)
### [VM extensions](vm\extension.pycliyml "az vm extension")
#### [az vm extension delete](vm\extension.pycliyml#delete)
#### [VM extension images](vm\extension\image.pycliyml "az vm extension image")
...
### [VM images](vm\image.pycliyml "az vm image")
...
## [VM scale sets (VMSS)](vmss.pycliyml "az vmss")
...
### [VMSS diagnostics](vmss\diagnostics.pycliyml "az vmss diagnostics")
...
### [VMSS extensions](vmss\extension.pycliyml "az vmss extension")
#### [az vmss extension delete](vmss\extension.pycliyml#delete)
#### [VMSS extension images](vmss\extension\image.pycliyml "az vmss extension image")
