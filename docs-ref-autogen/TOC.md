...
## [Azure Active Directory (AAD "az ad")](ad.pycliyml "az ad")
...
## [Azure contexts](context.pycliyml "az context")
...
## [DocumentDB (NoSQL "az documentdb")](documentdb.pycliyml "az documentdb")
...
##### [DNS - MX (mail "az network dns record mx") records](network\dns\record\mx.pycliyml "az network dns record mx")
...
##### [DNS - NS (nameserver "az network dns record ns") records](network\dns\record\ns.pycliyml "az network dns record ns")
###### [az network dns record ns add](network\dns\record\ns.pycliyml#add)
###### [az network dns record ns remove](network\dns\record\ns.pycliyml#remove)
##### [DNS - PTR (pointer "az network dns record ptr") records](network\dns\record\ptr.pycliyml "az network dns record ptr")
...
## [Virtual machines (VM "az vm")](vm.pycliyml "az vm")
...
## [VM scale sets (VMSS "az vmss")](vmss.pycliyml "az vmss")
