...
##### [Ssl](appservice\web\config\ssl.pycliyml "az appservice web config ssl")
...
## [Datalake](datalake.pycliyml "az datalake")
### [Analytics](datalake\analytics.pycliyml "az datalake analytics")
#### [Account](datalake\analytics\account.pycliyml "az datalake analytics account")
##### [Create](datalake\analytics\account.pycliyml#create "az datalake analytics account create")
##### [Delete](datalake\analytics\account.pycliyml#delete "az datalake analytics account delete")
##### [List](datalake\analytics\account.pycliyml#list "az datalake analytics account list")
##### [Show](datalake\analytics\account.pycliyml#show "az datalake analytics account show")
##### [Update](datalake\analytics\account.pycliyml#update "az datalake analytics account update")
##### [Blob](datalake\analytics\account\blob.pycliyml "az datalake analytics account blob")
###### [Add](datalake\analytics\account\blob.pycliyml#add "az datalake analytics account blob add")
###### [Delete](datalake\analytics\account\blob.pycliyml#delete "az datalake analytics account blob delete")
###### [List](datalake\analytics\account\blob.pycliyml#list "az datalake analytics account blob list")
###### [Show](datalake\analytics\account\blob.pycliyml#show "az datalake analytics account blob show")
###### [Update](datalake\analytics\account\blob.pycliyml#update "az datalake analytics account blob update")
##### [Datalake-Store](datalake\analytics\account\datalake-store.pycliyml "az datalake analytics account datalake-store")
###### [Add](datalake\analytics\account\datalake-store.pycliyml#add "az datalake analytics account datalake-store add")
###### [Delete](datalake\analytics\account\datalake-store.pycliyml#delete "az datalake analytics account datalake-store delete")
###### [List](datalake\analytics\account\datalake-store.pycliyml#list "az datalake analytics account datalake-store list")
###### [Show](datalake\analytics\account\datalake-store.pycliyml#show "az datalake analytics account datalake-store show")
##### [Firewall](datalake\analytics\account\firewall.pycliyml "az datalake analytics account firewall")
###### [Create](datalake\analytics\account\firewall.pycliyml#create "az datalake analytics account firewall create")
###### [Delete](datalake\analytics\account\firewall.pycliyml#delete "az datalake analytics account firewall delete")
###### [List](datalake\analytics\account\firewall.pycliyml#list "az datalake analytics account firewall list")
###### [Show](datalake\analytics\account\firewall.pycliyml#show "az datalake analytics account firewall show")
###### [Update](datalake\analytics\account\firewall.pycliyml#update "az datalake analytics account firewall update")
#### [Catalog](datalake\analytics\catalog.pycliyml "az datalake analytics catalog")
##### [Assembly](datalake\analytics\catalog\assembly.pycliyml "az datalake analytics catalog assembly")
###### [List](datalake\analytics\catalog\assembly.pycliyml#list "az datalake analytics catalog assembly list")
###### [Show](datalake\analytics\catalog\assembly.pycliyml#show "az datalake analytics catalog assembly show")
##### [Credential](datalake\analytics\catalog\credential.pycliyml "az datalake analytics catalog credential")
###### [Create](datalake\analytics\catalog\credential.pycliyml#create "az datalake analytics catalog credential create")
###### [Delete](datalake\analytics\catalog\credential.pycliyml#delete "az datalake analytics catalog credential delete")
###### [List](datalake\analytics\catalog\credential.pycliyml#list "az datalake analytics catalog credential list")
###### [Show](datalake\analytics\catalog\credential.pycliyml#show "az datalake analytics catalog credential show")
###### [Update](datalake\analytics\catalog\credential.pycliyml#update "az datalake analytics catalog credential update")
##### [Database](datalake\analytics\catalog\database.pycliyml "az datalake analytics catalog database")
###### [List](datalake\analytics\catalog\database.pycliyml#list "az datalake analytics catalog database list")
###### [Show](datalake\analytics\catalog\database.pycliyml#show "az datalake analytics catalog database show")
##### [Externaldatasource](datalake\analytics\catalog\externaldatasource.pycliyml "az datalake analytics catalog externaldatasource")
###### [List](datalake\analytics\catalog\externaldatasource.pycliyml#list "az datalake analytics catalog externaldatasource list")
###### [Show](datalake\analytics\catalog\externaldatasource.pycliyml#show "az datalake analytics catalog externaldatasource show")
##### [Procedure](datalake\analytics\catalog\procedure.pycliyml "az datalake analytics catalog procedure")
###### [List](datalake\analytics\catalog\procedure.pycliyml#list "az datalake analytics catalog procedure list")
###### [Show](datalake\analytics\catalog\procedure.pycliyml#show "az datalake analytics catalog procedure show")
##### [Schema](datalake\analytics\catalog\schema.pycliyml "az datalake analytics catalog schema")
###### [List](datalake\analytics\catalog\schema.pycliyml#list "az datalake analytics catalog schema list")
###### [Show](datalake\analytics\catalog\schema.pycliyml#show "az datalake analytics catalog schema show")
##### [Table](datalake\analytics\catalog\table.pycliyml "az datalake analytics catalog table")
###### [List](datalake\analytics\catalog\table.pycliyml#list "az datalake analytics catalog table list")
###### [Show](datalake\analytics\catalog\table.pycliyml#show "az datalake analytics catalog table show")
##### [Tablepartition](datalake\analytics\catalog\tablepartition.pycliyml "az datalake analytics catalog tablepartition")
###### [List](datalake\analytics\catalog\tablepartition.pycliyml#list "az datalake analytics catalog tablepartition list")
###### [Show](datalake\analytics\catalog\tablepartition.pycliyml#show "az datalake analytics catalog tablepartition show")
##### [Tablestats](datalake\analytics\catalog\tablestats.pycliyml "az datalake analytics catalog tablestats")
###### [List](datalake\analytics\catalog\tablestats.pycliyml#list "az datalake analytics catalog tablestats list")
###### [Show](datalake\analytics\catalog\tablestats.pycliyml#show "az datalake analytics catalog tablestats show")
##### [Tabletype](datalake\analytics\catalog\tabletype.pycliyml "az datalake analytics catalog tabletype")
###### [List](datalake\analytics\catalog\tabletype.pycliyml#list "az datalake analytics catalog tabletype list")
###### [Show](datalake\analytics\catalog\tabletype.pycliyml#show "az datalake analytics catalog tabletype show")
##### [Tablevaluedfunction](datalake\analytics\catalog\tablevaluedfunction.pycliyml "az datalake analytics catalog tablevaluedfunction")
###### [List](datalake\analytics\catalog\tablevaluedfunction.pycliyml#list "az datalake analytics catalog tablevaluedfunction list")
###### [Show](datalake\analytics\catalog\tablevaluedfunction.pycliyml#show "az datalake analytics catalog tablevaluedfunction show")
##### [View](datalake\analytics\catalog\view.pycliyml "az datalake analytics catalog view")
###### [List](datalake\analytics\catalog\view.pycliyml#list "az datalake analytics catalog view list")
###### [Show](datalake\analytics\catalog\view.pycliyml#show "az datalake analytics catalog view show")
#### [Job](datalake\analytics\job.pycliyml "az datalake analytics job")
##### [Cancel](datalake\analytics\job.pycliyml#cancel "az datalake analytics job cancel")
##### [List](datalake\analytics\job.pycliyml#list "az datalake analytics job list")
##### [Show](datalake\analytics\job.pycliyml#show "az datalake analytics job show")
##### [Submit](datalake\analytics\job.pycliyml#submit "az datalake analytics job submit")
##### [Wait](datalake\analytics\job.pycliyml#wait "az datalake analytics job wait")
### [Store](datalake\store.pycliyml "az datalake store")
#### [Account](datalake\store\account.pycliyml "az datalake store account")
##### [Create](datalake\store\account.pycliyml#create "az datalake store account create")
##### [Delete](datalake\store\account.pycliyml#delete "az datalake store account delete")
##### [List](datalake\store\account.pycliyml#list "az datalake store account list")
##### [Show](datalake\store\account.pycliyml#show "az datalake store account show")
##### [Update](datalake\store\account.pycliyml#update "az datalake store account update")
##### [Firewall](datalake\store\account\firewall.pycliyml "az datalake store account firewall")
###### [Create](datalake\store\account\firewall.pycliyml#create "az datalake store account firewall create")
###### [Delete](datalake\store\account\firewall.pycliyml#delete "az datalake store account firewall delete")
###### [List](datalake\store\account\firewall.pycliyml#list "az datalake store account firewall list")
###### [Show](datalake\store\account\firewall.pycliyml#show "az datalake store account firewall show")
###### [Update](datalake\store\account\firewall.pycliyml#update "az datalake store account firewall update")
##### [Trusted-Provider](datalake\store\account\trusted-provider.pycliyml "az datalake store account trusted-provider")
###### [Create](datalake\store\account\trusted-provider.pycliyml#create "az datalake store account trusted-provider create")
###### [Delete](datalake\store\account\trusted-provider.pycliyml#delete "az datalake store account trusted-provider delete")
###### [List](datalake\store\account\trusted-provider.pycliyml#list "az datalake store account trusted-provider list")
###### [Show](datalake\store\account\trusted-provider.pycliyml#show "az datalake store account trusted-provider show")
###### [Update](datalake\store\account\trusted-provider.pycliyml#update "az datalake store account trusted-provider update")
#### [File](datalake\store\file.pycliyml "az datalake store file")
##### [Append](datalake\store\file.pycliyml#append "az datalake store file append")
##### [Create](datalake\store\file.pycliyml#create "az datalake store file create")
##### [Delete](datalake\store\file.pycliyml#delete "az datalake store file delete")
##### [Download](datalake\store\file.pycliyml#download "az datalake store file download")
##### [Join](datalake\store\file.pycliyml#join "az datalake store file join")
##### [List](datalake\store\file.pycliyml#list "az datalake store file list")
##### [Move](datalake\store\file.pycliyml#move "az datalake store file move")
##### [Preview](datalake\store\file.pycliyml#preview "az datalake store file preview")
##### [Set-Owner](datalake\store\file.pycliyml#set-owner "az datalake store file set-owner")
##### [Set-Permission](datalake\store\file.pycliyml#set-permission "az datalake store file set-permission")
##### [Show](datalake\store\file.pycliyml#show "az datalake store file show")
##### [Test](datalake\store\file.pycliyml#test "az datalake store file test")
##### [Upload](datalake\store\file.pycliyml#upload "az datalake store file upload")
...
##### [Mx](network\dns\record-set\mx.pycliyml "az network dns record-set mx")
...
##### [Ptr](network\dns\record-set\ptr.pycliyml "az network dns record-set ptr")
...
#### [Create-Replica](sql\db.pycliyml#create-replica "az sql db create-replica")
...
#### [Replica-Link](sql\db\replica-link.pycliyml "az sql db replica-link")
##### [Delete](sql\db\replica-link.pycliyml#delete "az sql db replica-link delete")
##### [Failover](sql\db\replica-link.pycliyml#failover "az sql db replica-link failover")
##### [Force-Failover](sql\db\replica-link.pycliyml#force-failover "az sql db replica-link force-failover")
##### [List](sql\db\replica-link.pycliyml#list "az sql db replica-link list")
##### [Show](sql\db\replica-link.pycliyml#show "az sql db replica-link show")
### [Dw](sql\dw.pycliyml "az sql dw")
...
### [Elastic-Pool](sql\elastic-pool.pycliyml "az sql elastic-pool")
...
#### [Firewall-Rule](sql\server\firewall-rule.pycliyml "az sql server firewall-rule")
