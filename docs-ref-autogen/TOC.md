...
#### [records](network\dns\record.pycliyml "az network dns record")
##### [A](network\dns\record\a.pycliyml "az network dns record a")
...
##### [AAAA](network\dns\record\aaaa.pycliyml "az network dns record aaaa")
...
##### [CNAME](network\dns\record\cname.pycliyml "az network dns record cname")
...
##### [MX (mail)](network\dns\record\mx.pycliyml "az network dns record mx")
...
##### [SRV](network\dns\record\srv.pycliyml "az network dns record srv")
...
##### [TXT](network\dns\record\txt.pycliyml "az network dns record txt")
...
#### [Elastic pool database activity](sql\elastic-pools\db.pycliyml "az sql elastic-pools db")
...
#### [Recommended elastic pools](sql\elastic-pools\recommended.pycliyml "az sql elastic-pools recommended")
##### [Elastic pool database](sql\elastic-pools\recommended\db.pycliyml "az sql elastic-pools recommended db")
...
### [User access](vm\access.pycliyml "az vm access")
...
## [Scale sets (VMSS)](vmss.pycliyml "az vmss")
...
#### [Extension images](vmss\extension\image.pycliyml "az vmss extension image")
