...
##### [Show](functionapp\config\appsettings.pycliyml#show "az functionapp config appsettings show")
...
##### [Show](webapp\config\connection-string.pycliyml#show "az webapp config connection-string show")
