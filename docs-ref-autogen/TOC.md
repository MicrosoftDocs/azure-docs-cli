...
#### [All-Statistics](batch\pool\all-statistics.pycliyml "az batch pool all-statistics")
...
##### [Update-Soa](network\dns\record.pycliyml#update-soa "az network dns record update-soa")
##### [A](network\dns\record\a.pycliyml "az network dns record a")
###### [Add](network\dns\record\a.pycliyml#add "az network dns record a add")
###### [Remove](network\dns\record\a.pycliyml#remove "az network dns record a remove")
##### [AAAA](network\dns\record\aaaa.pycliyml "az network dns record aaaa")
###### [Add](network\dns\record\aaaa.pycliyml#add "az network dns record aaaa add")
###### [Remove](network\dns\record\aaaa.pycliyml#remove "az network dns record aaaa remove")
##### [CNAME](network\dns\record\cname.pycliyml "az network dns record cname")
###### [Add](network\dns\record\cname.pycliyml#add "az network dns record cname add")
###### [Remove](network\dns\record\cname.pycliyml#remove "az network dns record cname remove")
##### [MX (mail)](network\dns\record\mx.pycliyml "az network dns record mx")
###### [Add](network\dns\record\mx.pycliyml#add "az network dns record mx add")
###### [Remove](network\dns\record\mx.pycliyml#remove "az network dns record mx remove")
##### [NS (nameserver)](network\dns\record\ns.pycliyml "az network dns record ns")
###### [Add](network\dns\record\ns.pycliyml#add "az network dns record ns add")
###### [Remove](network\dns\record\ns.pycliyml#remove "az network dns record ns remove")
##### [PTR (pointer)](network\dns\record\ptr.pycliyml "az network dns record ptr")
###### [Add](network\dns\record\ptr.pycliyml#add "az network dns record ptr add")
###### [Remove](network\dns\record\ptr.pycliyml#remove "az network dns record ptr remove")
##### [SRV](network\dns\record\srv.pycliyml "az network dns record srv")
###### [Add](network\dns\record\srv.pycliyml#add "az network dns record srv add")
###### [Remove](network\dns\record\srv.pycliyml#remove "az network dns record srv remove")
##### [TXT](network\dns\record\txt.pycliyml "az network dns record txt")
###### [Add](network\dns\record\txt.pycliyml#add "az network dns record txt add")
###### [Remove](network\dns\record\txt.pycliyml#remove "az network dns record txt remove")
#### [Record sets](network\dns\record-set.pycliyml "az network dns record-set")
##### [Create](network\dns\record-set.pycliyml#create "az network dns record-set create")
##### [Delete](network\dns\record-set.pycliyml#delete "az network dns record-set delete")
##### [List](network\dns\record-set.pycliyml#list "az network dns record-set list")
##### [Show](network\dns\record-set.pycliyml#show "az network dns record-set show")
##### [Update](network\dns\record-set.pycliyml#update "az network dns record-set update")
...
#### [Show-Usage](sql\db.pycliyml#show-usage "az sql db show-usage")
#### [Update](sql\db.pycliyml#update "az sql db update")
#### [Data warehouses](sql\db\data-warehouse.pycliyml "az sql db data-warehouse")
##### [Pause](sql\db\data-warehouse.pycliyml#pause "az sql db data-warehouse pause")
##### [Resume](sql\db\data-warehouse.pycliyml#resume "az sql db data-warehouse resume")
#### [Replication links](sql\db\replication-link.pycliyml "az sql db replication-link")
##### [Delete](sql\db\replication-link.pycliyml#delete "az sql db replication-link delete")
##### [Failover](sql\db\replication-link.pycliyml#failover "az sql db replication-link failover")
##### [Force-Failover](sql\db\replication-link.pycliyml#force-failover "az sql db replication-link force-failover")
##### [List](sql\db\replication-link.pycliyml#list "az sql db replication-link list")
##### [Show](sql\db\replication-link.pycliyml#show "az sql db replication-link show")
#### [Restore points](sql\db\restore-point.pycliyml "az sql db restore-point")
##### [List](sql\db\restore-point.pycliyml#list "az sql db restore-point list")
#### [Service tier advisors](sql\db\service-tier-advisor.pycliyml "az sql db service-tier-advisor")
##### [List](sql\db\service-tier-advisor.pycliyml#list "az sql db service-tier-advisor list")
##### [Show](sql\db\service-tier-advisor.pycliyml#show "az sql db service-tier-advisor show")
#### [Transparent data encryption](sql\db\transparent-data-encryption.pycliyml "az sql db transparent-data-encryption")
##### [Create](sql\db\transparent-data-encryption.pycliyml#create "az sql db transparent-data-encryption create")
##### [Show-Activity](sql\db\transparent-data-encryption.pycliyml#show-activity "az sql db transparent-data-encryption show-activity")
##### [Show-Configuration](sql\db\transparent-data-encryption.pycliyml#show-configuration "az sql db transparent-data-encryption show-configuration")
### [Elastic pools](sql\elastic-pools.pycliyml "az sql elastic-pools")
#### [Create](sql\elastic-pools.pycliyml#create "az sql elastic-pools create")
#### [Delete](sql\elastic-pools.pycliyml#delete "az sql elastic-pools delete")
#### [List](sql\elastic-pools.pycliyml#list "az sql elastic-pools list")
#### [Show](sql\elastic-pools.pycliyml#show "az sql elastic-pools show")
#### [Update](sql\elastic-pools.pycliyml#update "az sql elastic-pools update")
#### [Database activity](sql\elastic-pools\db.pycliyml "az sql elastic-pools db")
##### [List](sql\elastic-pools\db.pycliyml#list "az sql elastic-pools db list")
##### [Show](sql\elastic-pools\db.pycliyml#show "az sql elastic-pools db show")
##### [Show-Activity](sql\elastic-pools\db.pycliyml#show-activity "az sql elastic-pools db show-activity")
#### [Recommended](sql\elastic-pools\recommended.pycliyml "az sql elastic-pools recommended")
##### [List](sql\elastic-pools\recommended.pycliyml#list "az sql elastic-pools recommended list")
##### [Show](sql\elastic-pools\recommended.pycliyml#show "az sql elastic-pools recommended show")
##### [Show-Metrics](sql\elastic-pools\recommended.pycliyml#show-metrics "az sql elastic-pools recommended show-metrics")
##### [Database](sql\elastic-pools\recommended\db.pycliyml "az sql elastic-pools recommended db")
###### [List](sql\elastic-pools\recommended\db.pycliyml#list "az sql elastic-pools recommended db list")
###### [Show](sql\elastic-pools\recommended\db.pycliyml#show "az sql elastic-pools recommended db show")
...
#### [Show-Usage](sql\server.pycliyml#show-usage "az sql server show-usage")
#### [Update](sql\server.pycliyml#update "az sql server update")
#### [Firewalls](sql\server\firewall.pycliyml "az sql server firewall")
##### [Create](sql\server\firewall.pycliyml#create "az sql server firewall create")
##### [Delete](sql\server\firewall.pycliyml#delete "az sql server firewall delete")
##### [List](sql\server\firewall.pycliyml#list "az sql server firewall list")
##### [Show](sql\server\firewall.pycliyml#show "az sql server firewall show")
##### [Update](sql\server\firewall.pycliyml#update "az sql server firewall update")
#### [Service objectives](sql\server\service-objective.pycliyml "az sql server service-objective")
##### [List](sql\server\service-objective.pycliyml#list "az sql server service-objective list")
##### [Show](sql\server\service-objective.pycliyml#show "az sql server service-objective show")
...
#### [Delete-Linux-User](vm\access.pycliyml#delete-linux-user "az vm access delete-linux-user")
#### [Reset-Linux-Ssh](vm\access.pycliyml#reset-linux-ssh "az vm access reset-linux-ssh")
#### [Reset-Windows-Admin](vm\access.pycliyml#reset-windows-admin "az vm access reset-windows-admin")
#### [Set-Linux-User](vm\access.pycliyml#set-linux-user "az vm access set-linux-user")
...
# [Reference](../docs-ref-conceptual/overview.md)
## [Install](../docs-ref-conceptual/install-az-cli2.md)
## [Get started](../docs-ref-conceptual/get-started-with-az-cli2.md)
## [Authenticate](../docs-ref-conceptual/authenticate-az-cli2.md)
## [Output formats](../docs-ref-conceptual/format-output-az-cli2.md)
